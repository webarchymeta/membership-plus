...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class SignalRHostStateSetConstraints
    {
        ...
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(SignalRHostStateSetConstraints constraints)
        {
            return ApplicationIDWrap.KeyValue == constraints.ApplicationIDWrap.KeyValue;
        }
    }
    ...
    public class SignalRHostStateSetConstraintsColl
    {
        ...
        [DataMember]
        public SignalRHostStateSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    public class SignalRHostStateSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<SignalRHostStatePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<SignalRHostStatePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<SignalRHostStatePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<SignalRHostStatePage> _pagesWindow;
        ...
        public SignalRHostStateSet()
        {
            NameSpace = "dbo";
            //Name = "SignalRHostStates " + StringResources.Table;
            Name = "SignalRHostStates " + "Table";
            EntityName = "SignalRHostState";
            //... other init
            _pages = new List<SignalRHostStatePage>();
        }
    }
