...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "ShortMessageAttachments".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAttachmentSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (MessageIDWrap != null ? MessageIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the MessageID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> MessageIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(ShortMessageAttachmentSetConstraints constraints)
        {
            return MessageIDWrap.KeyValue == constraints.MessageIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "ShortMessageAttachments".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAttachmentSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public ShortMessageAttachmentSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "ShortMessageAttachments".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAttachmentSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<ShortMessageAttachmentPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<ShortMessageAttachmentPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<ShortMessageAttachmentPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<ShortMessageAttachmentPage> _pagesWindow;
        ...
        public ShortMessageAttachmentSet()
        {
            NameSpace = "dbo";
            //Name = "ShortMessageAttachments " + StringResources.Table;
            Name = "ShortMessageAttachments " + "Table";
            EntityName = "ShortMessageAttachment";
            //... other init
            _pages = new List<ShortMessageAttachmentPage>();
        }
    }
