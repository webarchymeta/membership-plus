...
{
    /// <summary>
    /// A structure representing the data set of "Applications".
    /// </summary>
    [DataContract]
    public class Application_Set
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<Application_Page> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<Application_Page> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<Application_Page> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<Application_Page> _pagesWindow;
        ...
        public Application_Set()
        {
            NameSpace = "dbo";
            //Name = "Applications " + StringResources.Table;
            Name = "Applications " + "Table";
            EntityName = "Application_";
            //... other init
            _pages = new List<Application_Page>();
        }
    }
