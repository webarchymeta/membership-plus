...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "UserAssociations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserAssociationSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (FromUserIDWrap != null ? FromUserIDWrap.CacheKey : "" ) + "_" + (ToUserIDWrap != null ? ToUserIDWrap.CacheKey : "" ) + "_" + (TypeIDWrap != null ? TypeIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserAssociationSetConstraints constraints)
        {
            return FromUserIDWrap.KeyValue == constraints.FromUserIDWrap.KeyValue && ToUserIDWrap.KeyValue == constraints.ToUserIDWrap.KeyValue && TypeIDWrap.KeyValue == constraints.TypeIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "UserAssociations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserAssociationSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public UserAssociationSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "UserAssociations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserAssociationSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<UserAssociationPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserAssociationPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserAssociationPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserAssociationPage> _pagesWindow;
        ...
        public UserAssociationSet()
        {
            NameSpace = "dbo";
            //Name = "UserAssociations " + StringResources.Table;
            Name = "UserAssociations " + "Table";
            EntityName = "UserAssociation";
            //... other init
            _pages = new List<UserAssociationPage>();
        }
    }
