...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class EventTypePageBlock
    {
        /// <summary>
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="EventType" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventTypePage
    {
        /// <summary>
        ...
        /// </summary>
        public List<EventType> Items
        {
            get;
            set;
        }

        public EventTypePage(int idx)
        {
            _index = idx;
        }
