...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class MemberNotificationPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public MemberNotificationPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="MemberNotification" />.
    /// </summary>
    [DataContract]
    public class MemberNotificationPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public MemberNotification FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public MemberNotification LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<MemberNotification> Items
        {
            get;
            set;
        }

        public MemberNotificationPage(int idx)
        {
            _index = idx;
        }
