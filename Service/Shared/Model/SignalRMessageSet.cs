...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class SignalRMessageSetConstraints
    {
        ...
        /// <returns></returns>
        public bool IsTheSameAs(SignalRMessageSetConstraints constraints)
        {
    ...
    public class SignalRMessageSetConstraintsColl
    {
        ...
        [DataMember]
        public SignalRMessageSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    public class SignalRMessageSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<SignalRMessagePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<SignalRMessagePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<SignalRMessagePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<SignalRMessagePage> _pagesWindow;
        ...
        public SignalRMessageSet()
        {
            NameSpace = "dbo";
            //Name = "SignalRMessages " + StringResources.Table;
            Name = "SignalRMessages " + "Table";
            EntityName = "SignalRMessage";
            //... other init
            _pages = new List<SignalRMessagePage>();
        }
    }
