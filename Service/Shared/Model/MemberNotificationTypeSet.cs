...
{
    /// <summary>
    /// A structure representing the data set of "MemberNotificationTypes".
    /// </summary>
    [DataContract]
    public class MemberNotificationTypeSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<MemberNotificationTypePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<MemberNotificationTypePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<MemberNotificationTypePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<MemberNotificationTypePage> _pagesWindow;
        ...
        public MemberNotificationTypeSet()
        {
            NameSpace = "dbo";
            //Name = "MemberNotificationTypes " + StringResources.Table;
            Name = "MemberNotificationTypes " + "Table";
            EntityName = "MemberNotificationType";
            //... other init
            _pages = new List<MemberNotificationTypePage>();
        }
    }
