...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "UserProfiles".
    /// </summary>
    [DataContract]
    public class UserProfileSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_" + (TypeIDWrap != null ? TypeIDWrap.CacheKey : "" ) + "_" + (UserIDWrap != null ? UserIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserProfileSetConstraints constraints)
        {
            return ApplicationIDWrap.KeyValue == constraints.ApplicationIDWrap.KeyValue && TypeIDWrap.KeyValue == constraints.TypeIDWrap.KeyValue && UserIDWrap.KeyValue == constraints.UserIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "UserProfiles".
    /// </summary>
    [DataContract]
    public class UserProfileSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public UserProfileSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "UserProfiles".
    /// </summary>
    [DataContract]
    public class UserProfileSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<UserProfilePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserProfilePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserProfilePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserProfilePage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "UserProfiles " + StringResources.Table;
            Name = "UserProfiles " + "Table";
            EntityName = "UserProfile";
            //... other init
            _pages = new List<UserProfilePage>();
        }
    }
