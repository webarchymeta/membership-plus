...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UserGroupTypePageBlock
    {
        ...
        /// </summary>
        [DataMember]
        public UserGroupTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserGroupType" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserGroupTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserGroupType> Items
        {
            get;
            set;
        }

        public UserGroupTypePage(int idx)
        {
            _index = idx;
        }
