...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "ShortMessages".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_" + (FromIDWrap != null ? FromIDWrap.CacheKey : "" ) + "_" + (TypeIDWrap != null ? TypeIDWrap.CacheKey : "" ) + "_" + (GroupIDWrap != null ? GroupIDWrap.CacheKey : "" ) + "_" + (ReplyToIDWrap != null ? ReplyToIDWrap.CacheKey : "" ) + "_" + (ToIDWrap != null ? ToIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the FromID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> FromIDWrap
        {
            get;
            set;
        }
        /// <summary>
        /// The wrapper for the TypeID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<int> TypeIDWrap
        {
            get;
            set;
        }
        ...
        /// <summary>
        /// The wrapper for the ReplyToID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> ReplyToIDWrap
        {
            get;
            set;
        }
        /// <summary>
        /// The wrapper for the ToID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> ToIDWrap
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a limited set of available constraints of "ShortMessages".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public ShortMessageSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "ShortMessages".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<ShortMessagePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<ShortMessagePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<ShortMessagePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<ShortMessagePage> _pagesWindow;
        ...
        public ShortMessageSet()
        {
            NameSpace = "dbo";
            //Name = "ShortMessages " + StringResources.Table;
            Name = "ShortMessages " + "Table";
            EntityName = "ShortMessage";
            //... other init
            _pages = new List<ShortMessagePage>();
        }
    }
