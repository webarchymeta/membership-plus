...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class NotificationTaskSchedulePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public NotificationTaskSchedulePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="NotificationTaskSchedule" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class NotificationTaskSchedulePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public NotificationTaskSchedule FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public NotificationTaskSchedule LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<NotificationTaskSchedule> Items
        {
            get;
            set;
        }

        public NotificationTaskSchedulePage(int idx)
        {
            _index = idx;
        }
