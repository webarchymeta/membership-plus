...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserAppMemberPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAppMemberPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserAppMember" />.
    /// </summary>
    [DataContract]
    public class UserAppMemberPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAppMember FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserAppMember> Items
        {
            get;
            set;
        }

        public UserAppMemberPage(int idx)
        {
            _index = idx;
        }
