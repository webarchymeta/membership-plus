...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class ShortMessageAttachmentPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAttachmentPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="ShortMessageAttachment" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAttachmentPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAttachment FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAttachment LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<ShortMessageAttachment> Items
        {
            get;
            set;
        }

        public ShortMessageAttachmentPage(int idx)
        {
            _index = idx;
        }
