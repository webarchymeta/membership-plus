...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class EventStackFramePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public EventStackFramePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="EventStackFrame" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventStackFramePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public EventStackFrame FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public EventStackFrame LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<EventStackFrame> Items
        {
            get;
            set;
        }

        public EventStackFramePage(int idx)
        {
            _index = idx;
        }
