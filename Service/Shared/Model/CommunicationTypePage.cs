...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class CommunicationTypePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public CommunicationTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="CommunicationType" />.
    /// </summary>
    [DataContract]
    public class CommunicationTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public CommunicationType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public CommunicationType LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<CommunicationType> Items
        {
            get;
            set;
        }

        public CommunicationTypePage(int idx)
        {
            _index = idx;
        }
