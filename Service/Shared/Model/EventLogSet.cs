...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "EventLogs".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLogSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (AppIDWrap != null ? AppIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the AppID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> AppIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(EventLogSetConstraints constraints)
        {
            return AppIDWrap.KeyValue == constraints.AppIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "EventLogs".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLogSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public EventLogSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "EventLogs".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLogSet
    {
        /// <summary>
        /// The value of entity property <see cref="EventLog.EventLevel" /> is descrete (expandable). 
        /// This is the possible options: { "OFF", "FATAL", "ERROR", "WARN", "INFO", "DEBUG", "ALL" }
        /// </summary>
        [DataMember]
        public string[] EventLevelValues
        {
            get
            {
                if (_EventLevelValues == null)
                {
                    _EventLevelValues = new string[] {
                                  "OFF",
                                  "FATAL",
                                  "ERROR",
                                  "WARN",
        ...
        private string[] _EventLevelValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<EventLogPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<EventLogPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<EventLogPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<EventLogPage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "EventLogs " + StringResources.Table;
            Name = "EventLogs " + "Table";
            EntityName = "EventLog";
            //... other init
            _pages = new List<EventLogPage>();
        }
    }
