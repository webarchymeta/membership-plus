...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "EventStackFrames".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventStackFrameSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (EventIDWrap != null ? EventIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(EventStackFrameSetConstraints constraints)
        {
            return EventIDWrap.KeyValue == constraints.EventIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "EventStackFrames".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventStackFrameSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public EventStackFrameSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "EventStackFrames".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventStackFrameSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<EventStackFramePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<EventStackFramePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<EventStackFramePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<EventStackFramePage> _pagesWindow;
        ...
        public EventStackFrameSet()
        {
            NameSpace = "dbo";
            //Name = "EventStackFrames " + StringResources.Table;
            Name = "EventStackFrames " + "Table";
            EntityName = "EventStackFrame";
            //... other init
            _pages = new List<EventStackFramePage>();
        }
    }
