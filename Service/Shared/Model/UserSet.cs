...
{
    /// <summary>
    /// A structure representing the data set of "Users".
    /// </summary>
    [DataContract]
    [Serializable]
    ...
    {
        /// <summary>
        /// The value of entity property <see cref="User.PasswordFormat" /> is descrete (fixed). 
        /// This is the allowed values: { "Clear", "Encrypted", "Hashed" }
        /// </summary>
        [DataMember]
        public string[] PasswordFormatValues
        {
            get
            {
                if (_PasswordFormatValues == null)
                {
                    _PasswordFormatValues = new string[] {
                                  "Clear",
                                  "Encrypted",
                                  "Hashed"
                    };
                }
                return _PasswordFormatValues;
            }
            set
            {
            }
        }
        private string[] _PasswordFormatValues = null;

        /// <summary>
        /// The value of entity property <see cref="User.Status" /> is descrete (expandable). 
        /// This is the possible options: { "OK", "LockedOut", "Expired" }
        /// </summary>
        [DataMember]
        ...
        private string[] _StatusValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<UserPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserPage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "Users " + StringResources.Table;
            Name = "Users " + "Table";
            EntityName = "User";
            //... other init
            _pages = new List<UserPage>();
        }
    }
