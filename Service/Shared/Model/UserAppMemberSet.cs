...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UserAppMemberSetConstraints
    {
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserAppMemberSetConstraints constraints)
        {
    ...
    public class UserAppMemberSetConstraintsColl
    {
        ...
        [DataMember]
        public UserAppMemberSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    {
        /// <summary>
        /// The value of entity property <see cref="UserAppMember.MemberStatus" /> is descrete (expandable). 
        /// This is the possible options: { "OK", "Cancelled", "LockedOut", "Expired" }
        /// </summary>
        [DataMember]
        public string[] MemberStatusValues
        {
            get
            {
                if (_MemberStatusValues == null)
                {
                    _MemberStatusValues = new string[] {
                                  "OK",
                                  "Cancelled",
                                  "LockedOut",
                                  "Expired"
        ...
        private string[] _MemberStatusValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<UserAppMemberPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserAppMemberPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserAppMemberPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserAppMemberPage> _pagesWindow;
        ...
        public UserAppMemberSet()
        {
            NameSpace = "dbo";
            //Name = "UserAppMembers " + StringResources.Table;
            Name = "UserAppMembers " + "Table";
            EntityName = "UserAppMember";
            //... other init
            _pages = new List<UserAppMemberPage>();
        }
    }
