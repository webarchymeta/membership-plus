...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UsersInRoleSetConstraints
    {
        ...
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (RoleIDWrap != null ? RoleIDWrap.CacheKey : "" ) + "_" + (UserIDWrap != null ? UserIDWrap.CacheKey : "" ) + "_" + (AdminIDWrap != null ? AdminIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the AdminID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> AdminIDWrap
        {
            get;
            set;
        }
        ...
        {
            return RoleIDWrap.KeyValue == constraints.RoleIDWrap.KeyValue && UserIDWrap.KeyValue == constraints.UserIDWrap.KeyValue && AdminIDWrap.KeyValue == constraints.AdminIDWrap.KeyValue;
        }
    }
