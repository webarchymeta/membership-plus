...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class SignalRHostStatePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public SignalRHostStatePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="SignalRHostState" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class SignalRHostStatePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public SignalRHostState FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public SignalRHostState LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<SignalRHostState> Items
        {
            get;
            set;
        }

        public SignalRHostStatePage(int idx)
        {
            _index = idx;
        }
