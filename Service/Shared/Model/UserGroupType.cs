...
{
    /// <summary>
    /// A entity in "UserGroupTypes" data set.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///    <item>
    ///      <term>ID</term>
    ///      <description>See <see cref="UserGroupType.ID" />. Primary key; intrinsic id; fixed; not null.</description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ///    <listheader>
    ...
    ///    <item>
    ///      <term>KindName</term>
    ///      <description>See <see cref="UserGroupType.KindName" />. Fixed; not null; max-length = 50 characters.</description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ///    <listheader>
    ...
    ///    <item>
    ///      <term>KindLabel</term>
    ///      <description>See <see cref="UserGroupType.KindLabel" />. Editable; nullable; max-length = 100 characters.</description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ///    <listheader>
    ...
    ///      <description>See <see cref="UserGroupType.UserGroups" />, which is a sub-set of the data set "UserGroups" for <see cref="UserGroup" />.</description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [DataContract]
    [Serializable]
    public class UserGroupType : IDbEntity 
    {
        /// <summary>
        ...
        /// <summary>
        /// Used to matching entities in input adding or updating entity list and the returned ones, see <see cref="IUserGroupTypeService.AddOrUpdateEntities" />.
        /// </summary>
        [DataMember]
        ...
        { 
            get
            {
                string str = "";
                str += "ID = " + ID + "\r\n";
                if (IsKindLabelModified)
                    str += "Modified [KindLabel] = " + KindLabel + "\r\n";;
                return str.Trim();
            }
        }
        ...
        {
            return String.Format(@"{0}", KindName.Trim());
        }
...
#region constructors and serialization
        ...
        /// </summary>
        public UserGroupType(SerializationInfo info, StreamingContext context)
        {
            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(UserGroupType));
            var strm = new System.IO.MemoryStream();
            byte[] bf = (byte[])info.GetValue("data", typeof(byte[]));
            strm.Write(bf, 0, bf.Length);
            strm.Position = 0;
            var e = ser.ReadObject(strm) as UserGroupType;
            IsPersisted = false;
...
#region Properties of the current entity
        ...
        private string _KindName = default(string);
            ...
            set
            {
                if (_KindLabel != value)
                {
                    ...
                    if (StartAutoUpdating)
                        IsKindLabelModified = true;
                }
            }
        }
        private string _KindLabel = default(string);

        /// <summary>
        /// Wether or not the value of <see cref="KindLabel" /> was changed compared to what it was loaded last time. 
        /// Note: the backend data source updates the changed <see cref="KindLabel" /> only if this is set to true no matter what
        /// the actual value of <see cref="KindLabel" /> is.
        /// </summary>
        [DataMember]
        public bool IsKindLabelModified
        { 
            get
            {
                return _isKindLabelModified;
            }
            set
            {
                _isKindLabelModified = value;
            }
        }
...
#region Entities that depend on the current one.
        ...
        /// </returns>
        public bool IsEntityIdentical(UserGroupType other)
        {
            if (other == null)
                return false;
            if (ID != other.ID)
        ...
        ///   The result of comparison.
        /// </returns>
        public bool IsEntityTheSame(UserGroupType other)
        {
            if (other == null)
                return false;
            else
        ...
        /// <returns>
        /// </returns>
        public static void MergeChanges(UserGroupType from, UserGroupType to)
        {
            if (to.IsPersisted)
            {
                if (from.IsKindLabelModified && !to.IsKindLabelModified)
                {
                    to.KindLabel = from.KindLabel;
                    to.IsKindLabelModified = true;
                }
            }
            else
            {
                ...
                to.ID = from.ID;
                to.KindName = from.KindName;
                to.KindLabel = from.KindLabel;
                to.IsKindLabelModified = from.IsKindLabelModified;
            }
        }
        ...
        /// <returns>
        /// </returns>
        public void UpdateChanges(UserGroupType newdata)
        {
            int cnt = 0;
            if (KindLabel != newdata.KindLabel)
            {
                KindLabel = newdata.KindLabel;
                IsKindLabelModified = true;
                cnt++;
            }
        ...
        public void NormalizeValues()
        {
            ...
            if (KindName == null)
                KindName = "";
            if (!IsEntityChanged)
                IsEntityChanged = IsKindLabelModified;
            StartAutoUpdating = true;
        }
        ...
        public UserGroupType ShallowCopy(bool allData = false, bool preserveState = false, bool checkLoadState = false)
        {
            ...
            e.ID = ID;
            e.KindName = KindName;
            e.KindLabel = KindLabel;
            if (preserveState)
                e.IsKindLabelModified = IsKindLabelModified;
            else
                e.IsKindLabelModified = false;
...
----===== [[UserGroupType]] =====----
  ID = " + ID + @"");
            ...
            sb.Append(@"
  KindName = '" + KindName + @"'
  KindLabel = '" + (KindLabel != null ? KindLabel : "null") + @"'");
            if (IsKindLabelModified)
                sb.Append(@" (modified)");
            else
                sb.Append(@" (unchanged)");
...
");
    ...
    ///<summary>
    ///The result of an add or update of type <see cref="UserGroupType" />.
    ///</summary>
    [DataContract]
    [Serializable]
    public class UserGroupTypeUpdateResult : IUpdateResult
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupType UpdatedItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserGroupType ConflictItem
        {
            get;
            set;
        }
