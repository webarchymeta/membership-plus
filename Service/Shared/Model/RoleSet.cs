...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "Roles".
    /// </summary>
    [DataContract]
    public class RoleSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_" + (ParentIDWrap != null ? ParentIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// </summary>
        [DataMember]
        public ForeignKeyData<System.Nullable<int>> ParentIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(RoleSetConstraints constraints)
        {
            return ApplicationIDWrap.KeyValue == constraints.ApplicationIDWrap.KeyValue && ParentIDWrap.KeyValue == constraints.ParentIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "Roles".
    /// </summary>
    [DataContract]
    public class RoleSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public RoleSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "Roles".
    /// </summary>
    [DataContract]
    public class RoleSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<RolePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<RolePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<RolePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<RolePage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "Roles " + StringResources.Table;
            Name = "Roles " + "Table";
            EntityName = "Role";
            //... other init
            _pages = new List<RolePage>();
        }
    }
