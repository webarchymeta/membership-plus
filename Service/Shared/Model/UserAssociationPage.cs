...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserAssociationPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssociationPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserAssociation" />.
    /// </summary>
    [DataContract]
    public class UserAssociationPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssociation FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserAssociation LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserAssociation> Items
        {
            get;
            set;
        }

        public UserAssociationPage(int idx)
        {
            _index = idx;
        }
