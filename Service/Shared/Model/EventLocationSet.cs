...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "EventLocations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLocationSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        ...
        /// <returns></returns>
        public bool IsTheSameAs(EventLocationSetConstraints constraints)
        {
    ...
    /// <summary>
    /// A structure representing a limited set of available constraints of "EventLocations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLocationSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public EventLocationSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "EventLocations".
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLocationSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<EventLocationPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<EventLocationPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<EventLocationPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<EventLocationPage> _pagesWindow;
        ...
        public EventLocationSet()
        {
            NameSpace = "dbo";
            //Name = "EventLocations " + StringResources.Table;
            Name = "EventLocations " + "Table";
            EntityName = "EventLocation";
            //... other init
            _pages = new List<EventLocationPage>();
        }
    }
