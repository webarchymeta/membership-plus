...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "UserDetails".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserDetailSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserDetailSetConstraints constraints)
        {
    ...
    /// <summary>
    /// A structure representing a limited set of available constraints of "UserDetails".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserDetailSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public UserDetailSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "UserDetails".
    /// </summary>
    [DataContract]
    [Serializable]
    ...
    {
        /// <summary>
        /// The value of entity property <see cref="UserDetail.Gender" /> is descrete (expandable). 
        /// This is the possible options: { "M", "F", "B" }
        /// </summary>
        [DataMember]
        public string[] GenderValues
        {
            get
            {
                if (_GenderValues == null)
                {
                    _GenderValues = new string[] {
                                  "M",
                                  "F",
                                  "B"
                    };
        ...
        private string[] _GenderValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<UserDetailPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserDetailPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserDetailPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserDetailPage> _pagesWindow;
        ...
        public UserDetailSet()
        {
            NameSpace = "dbo";
            //Name = "UserDetails " + StringResources.Table;
            Name = "UserDetails " + "Table";
            EntityName = "UserDetail";
            //... other init
            _pages = new List<UserDetailPage>();
        }
    }
