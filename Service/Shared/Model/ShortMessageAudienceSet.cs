...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "ShortMessageAudiences".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAudienceSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (MsgIDWrap != null ? MsgIDWrap.CacheKey : "" ) + "_" + (UserIDWrap != null ? UserIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the MsgID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> MsgIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(ShortMessageAudienceSetConstraints constraints)
        {
            return MsgIDWrap.KeyValue == constraints.MsgIDWrap.KeyValue && UserIDWrap.KeyValue == constraints.UserIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "ShortMessageAudiences".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAudienceSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public ShortMessageAudienceSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "ShortMessageAudiences".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAudienceSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<ShortMessageAudiencePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<ShortMessageAudiencePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<ShortMessageAudiencePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<ShortMessageAudiencePage> _pagesWindow;
        ...
        public ShortMessageAudienceSet()
        {
            NameSpace = "dbo";
            //Name = "ShortMessageAudiences " + StringResources.Table;
            Name = "ShortMessageAudiences " + "Table";
            EntityName = "ShortMessageAudience";
            //... other init
            _pages = new List<ShortMessageAudiencePage>();
        }
    }
