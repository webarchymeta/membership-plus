...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "UserGroupAdminRoles".
    /// </summary>
    [DataContract]
    public class UserGroupAdminRoleSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (GroupIDWrap != null ? GroupIDWrap.CacheKey : "" ) + "_" + (RoleIDWrap != null ? RoleIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserGroupAdminRoleSetConstraints constraints)
        {
            return GroupIDWrap.KeyValue == constraints.GroupIDWrap.KeyValue && RoleIDWrap.KeyValue == constraints.RoleIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "UserGroupAdminRoles".
    /// </summary>
    [DataContract]
    public class UserGroupAdminRoleSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public UserGroupAdminRoleSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "UserGroupAdminRoles".
    /// </summary>
    [DataContract]
    public class UserGroupAdminRoleSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<UserGroupAdminRolePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserGroupAdminRolePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserGroupAdminRolePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserGroupAdminRolePage> _pagesWindow;
        ...
        public UserGroupAdminRoleSet()
        {
            NameSpace = "dbo";
            //Name = "UserGroupAdminRoles " + StringResources.Table;
            Name = "UserGroupAdminRoles " + "Table";
            EntityName = "UserGroupAdminRole";
            //... other init
            _pages = new List<UserGroupAdminRolePage>();
        }
    }
