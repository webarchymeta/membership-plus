...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class EventCalendarSetConstraints
    {
        ...
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_" + (CreatedUserIDWrap != null ? CreatedUserIDWrap.CacheKey : "" ) + "_" + (EventTypeIDWrap != null ? EventTypeIDWrap.CacheKey : "" ) + "_" + (GroupIDWrap != null ? GroupIDWrap.CacheKey : "" ) + "_" + (UserIDWrap != null ? UserIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the CreatedUserID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> CreatedUserIDWrap
        {
            get;
            set;
        }
        /// <summary>
        /// The wrapper for the EventTypeID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<System.Nullable<int>> EventTypeIDWrap
        {
            get;
            set;
        }
        /// <summary>
        /// The wrapper for the GroupID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> GroupIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(EventCalendarSetConstraints constraints)
        {
            return ApplicationIDWrap.KeyValue == constraints.ApplicationIDWrap.KeyValue && CreatedUserIDWrap.KeyValue == constraints.CreatedUserIDWrap.KeyValue && EventTypeIDWrap.KeyValue == constraints.EventTypeIDWrap.KeyValue && GroupIDWrap.KeyValue == constraints.GroupIDWrap.KeyValue && UserIDWrap.KeyValue == constraints.UserIDWrap.KeyValue;
        }
    }
    ...
    public class EventCalendarSetConstraintsColl
    {
        ...
        [DataMember]
        public EventCalendarSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    {
        /// <summary>
        /// The value of entity property <see cref="EventCalendar.EventStatus" /> is descrete (expandable). 
        /// This is the possible options: { "Booked", "Allocated", "Finished", "Closed" }
        /// </summary>
        [DataMember]
        public string[] EventStatusValues
        {
            get
            {
                if (_EventStatusValues == null)
                {
                    _EventStatusValues = new string[] {
                                  "Booked",
                                  "Allocated",
                                  "Finished",
                                  "Closed"
                ...
                return _EventStatusValues;
            }
            set
            {
            }
        }
        private string[] _EventStatusValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<EventCalendarPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<EventCalendarPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<EventCalendarPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<EventCalendarPage> _pagesWindow;
        ...
        public EventCalendarSet()
        {
            NameSpace = "dbo";
            //Name = "EventCalendar " + StringResources.Table;
            Name = "EventCalendar " + "Table";
            EntityName = "EventCalendar";
            //... other init
            _pages = new List<EventCalendarPage>();
        }
    }
