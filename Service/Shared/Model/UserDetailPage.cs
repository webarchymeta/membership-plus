...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserDetailPageBlock
    {
        /// <summary>
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserDetail" />.
    /// </summary>
    [DataContract]
    public class UserDetailPage
    {
        ...
        /// </summary>
        public List<UserDetail> Items
        {
            get;
            set;
        }

        public UserDetailPage(int idx)
        {
            _index = idx;
        }
