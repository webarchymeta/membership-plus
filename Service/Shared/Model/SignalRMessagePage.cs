...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class SignalRMessagePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public SignalRMessagePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="SignalRMessage" />.
    /// </summary>
    [DataContract]
    public class SignalRMessagePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public SignalRMessage FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public SignalRMessage LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<SignalRMessage> Items
        {
            get;
            set;
        }

        public SignalRMessagePage(int idx)
        {
            _index = idx;
        }
