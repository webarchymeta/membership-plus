...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class MemberNotificationTypePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public MemberNotificationTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="MemberNotificationType" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class MemberNotificationTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public MemberNotificationType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public MemberNotificationType LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<MemberNotificationType> Items
        {
            get;
            set;
        }

        public MemberNotificationTypePage(int idx)
        {
            _index = idx;
        }
