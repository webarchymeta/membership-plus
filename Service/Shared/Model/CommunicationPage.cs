...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class CommunicationPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public CommunicationPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="Communication" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class CommunicationPage
    {
        ...
        /// </summary>
        [DataMember]
        public Communication FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<Communication> Items
        {
            get;
            set;
        }

        public CommunicationPage(int idx)
        {
            _index = idx;
        }
