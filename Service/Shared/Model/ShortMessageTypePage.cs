...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class ShortMessageTypePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="ShortMessageType" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public ShortMessageType LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<ShortMessageType> Items
        {
            get;
            set;
        }

        public ShortMessageTypePage(int idx)
        {
            _index = idx;
        }
