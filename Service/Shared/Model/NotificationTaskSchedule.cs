...
#region constructors and serialization
        ...
        /// Default constructor.
        /// </summary>
        public NotificationTaskSchedule()
        {
        }
        ...
        /// </summary>
        public NotificationTaskSchedule(SerializationInfo info, StreamingContext context)
        {
            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(NotificationTaskSchedule));
            var strm = new System.IO.MemoryStream();
            byte[] bf = (byte[])info.GetValue("data", typeof(byte[]));
            strm.Write(bf, 0, bf.Length);
            strm.Position = 0;
            var e = ser.ReadObject(strm) as NotificationTaskSchedule;
            IsPersisted = false;
