...
{
    /// <summary>
    /// A structure representing the data set of "UserGroupTypes".
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserGroupTypeSet
    {
        /// <summary>
        /// The value of entity property <see cref="UserGroupType.KindName" /> is descrete (expandable). 
        /// This is the possible options: { "Directory", "Department", "Project", "Topical", "Interest", "Social", "Messaging", "Membership", "Announcement", "MailList", "EventSubscribe" }
        /// </summary>
        [DataMember]
        public string[] KindNameValues
        {
            get
            {
                if (_KindNameValues == null)
                {
                    _KindNameValues = new string[] {
                                  "Directory",
                                  "Department",
                                  "Project",
                                  "Topical",
                ...
                return _KindNameValues;
            }
            set
            {
            }
        }
        private string[] _KindNameValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<UserGroupTypePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserGroupTypePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserGroupTypePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserGroupTypePage> _pagesWindow;
        ...
        public UserGroupTypeSet()
        {
            NameSpace = "dbo";
            //Name = "UserGroupTypes " + StringResources.Table;
            Name = "UserGroupTypes " + "Table";
            EntityName = "UserGroupType";
            //... other init
            _pages = new List<UserGroupTypePage>();
        }
    }
