...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class CommunicationSetConstraints
    {
        ...
        /// <returns></returns>
        public bool IsTheSameAs(CommunicationSetConstraints constraints)
        {
    ...
    public class CommunicationSetConstraintsColl
    {
        ...
        [DataMember]
        public CommunicationSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    public class CommunicationSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<CommunicationPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<CommunicationPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<CommunicationPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<CommunicationPage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "Communications " + StringResources.Table;
            Name = "Communications " + "Table";
            EntityName = "Communication";
            //... other init
            _pages = new List<CommunicationPage>();
        }
    }
