...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class ShortMessagePageBlock
    {
        /// <summary>
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="ShortMessage" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessagePage
    {
        /// <summary>
        ...
        /// </summary>
        public List<ShortMessage> Items
        {
            get;
            set;
        }

        public ShortMessagePage(int idx)
        {
            _index = idx;
        }
