...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserAssociationTypePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssociationTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserAssociationType" />.
    /// </summary>
    [DataContract]
    public class UserAssociationTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssociationType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserAssociationType LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserAssociationType> Items
        {
            get;
            set;
        }

        public UserAssociationTypePage(int idx)
        {
            _index = idx;
        }
