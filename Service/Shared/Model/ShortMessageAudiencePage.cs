...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class ShortMessageAudiencePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAudiencePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="ShortMessageAudience" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageAudiencePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAudience FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public ShortMessageAudience LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<ShortMessageAudience> Items
        {
            get;
            set;
        }

        public ShortMessageAudiencePage(int idx)
        {
            _index = idx;
        }
