...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class EventTypeSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<EventTypePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<EventTypePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<EventTypePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<EventTypePage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "EventTypes " + StringResources.Table;
            Name = "EventTypes " + "Table";
            EntityName = "EventType";
            //... other init
            _pages = new List<EventTypePage>();
        }
    }
