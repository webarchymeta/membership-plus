...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "UserGroupMembers".
    /// </summary>
    [DataContract]
    public class UserGroupMemberSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (UserGroupIDWrap != null ? UserGroupIDWrap.CacheKey : "" ) + "_" + (UserIDWrap != null ? UserIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the UserGroupID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> UserGroupIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(UserGroupMemberSetConstraints constraints)
        {
            return UserGroupIDWrap.KeyValue == constraints.UserGroupIDWrap.KeyValue && UserIDWrap.KeyValue == constraints.UserIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "UserGroupMembers".
    /// </summary>
    [DataContract]
    public class UserGroupMemberSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public UserGroupMemberSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "UserGroupMembers".
    /// </summary>
    [DataContract]
    public class UserGroupMemberSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<UserGroupMemberPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserGroupMemberPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserGroupMemberPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserGroupMemberPage> _pagesWindow;
        ...
        public UserGroupMemberSet()
        {
            NameSpace = "dbo";
            //Name = "UserGroupMembers " + StringResources.Table;
            Name = "UserGroupMembers " + "Table";
            EntityName = "UserGroupMember";
            //... other init
            _pages = new List<UserGroupMemberPage>();
        }
    }
