...
{
    /// <summary>
    /// A structure representing the data set of "ShortMessageTypes".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageTypeSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<ShortMessageTypePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<ShortMessageTypePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<ShortMessageTypePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<ShortMessageTypePage> _pagesWindow;
        ...
        public ShortMessageTypeSet()
        {
            NameSpace = "dbo";
            //Name = "ShortMessageTypes " + StringResources.Table;
            Name = "ShortMessageTypes " + "Table";
            EntityName = "ShortMessageType";
            //... other init
            _pages = new List<ShortMessageTypePage>();
        }
    }
