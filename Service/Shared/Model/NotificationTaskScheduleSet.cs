...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "NotificationTaskSchedules".
    /// </summary>
    [DataContract]
    [Serializable]
    public class NotificationTaskScheduleSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (EventIDWrap != null ? EventIDWrap.CacheKey : "" ) + "_" + (NotificationIDWrap != null ? NotificationIDWrap.CacheKey : "" ) + "_" + (AssignerIDWrap != null ? AssignerIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the NotificationID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> NotificationIDWrap
        {
            get;
            set;
        }
        /// <summary>
        /// The wrapper for the AssignerID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> AssignerIDWrap
        {
            get;
            set;
        }
        ...
        /// <returns></returns>
        public bool IsTheSameAs(NotificationTaskScheduleSetConstraints constraints)
        {
            return EventIDWrap.KeyValue == constraints.EventIDWrap.KeyValue && NotificationIDWrap.KeyValue == constraints.NotificationIDWrap.KeyValue && AssignerIDWrap.KeyValue == constraints.AssignerIDWrap.KeyValue;
        }
    }

    /// <summary>
    /// A structure representing a limited set of available constraints of "NotificationTaskSchedules".
    /// </summary>
    [DataContract]
    [Serializable]
    public class NotificationTaskScheduleSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public NotificationTaskScheduleSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "NotificationTaskSchedules".
    /// </summary>
    [DataContract]
    [Serializable]
    public class NotificationTaskScheduleSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<NotificationTaskSchedulePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<NotificationTaskSchedulePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<NotificationTaskSchedulePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<NotificationTaskSchedulePage> _pagesWindow;
        ...
        public NotificationTaskScheduleSet()
        {
            NameSpace = "dbo";
            //Name = "NotificationTaskSchedules " + StringResources.Table;
            Name = "NotificationTaskSchedules " + "Table";
            EntityName = "NotificationTaskSchedule";
            //... other init
            _pages = new List<NotificationTaskSchedulePage>();
        }
    }
