...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class UserGroupAdminRolePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupAdminRolePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserGroupAdminRole" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserGroupAdminRolePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupAdminRole FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserGroupAdminRole LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserGroupAdminRole> Items
        {
            get;
            set;
        }

        public UserGroupAdminRolePage(int idx)
        {
            _index = idx;
        }
