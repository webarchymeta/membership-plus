...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    {
        /// <summary>
        /// The value of entity property <see cref="UserProfileType.SerializeType" /> is descrete (expandable). 
        /// This is the possible options: { "String", "Xml", "Binary", "ProviderSpecific" }
        /// </summary>
        [DataMember]
        public string[] SerializeTypeValues
        {
            get
            {
                if (_SerializeTypeValues == null)
                {
                    _SerializeTypeValues = new string[] {
                                  "String",
                                  "Xml",
                                  "Binary",
                                  "ProviderSpecific"
                ...
                return _SerializeTypeValues;
            }
            set
            {
            }
        }
        private string[] _SerializeTypeValues = null;
        ...
        /// </summary>
        [DataMember]
        public List<UserProfileTypePage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<UserProfileTypePage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<UserProfileTypePage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<UserProfileTypePage> _pagesWindow;
        ...
        public UserProfileTypeSet()
        {
            NameSpace = "dbo";
            //Name = "UserProfileTypes " + StringResources.Table;
            Name = "UserProfileTypes " + "Table";
            EntityName = "UserProfileType";
            //... other init
            _pages = new List<UserProfileTypePage>();
        }
    }
