...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class MemberNotificationSetConstraints
    {
        ...
        /// <returns></returns>
        public bool IsTheSameAs(MemberNotificationSetConstraints constraints)
        {
    ...
    public class MemberNotificationSetConstraintsColl
    {
        ...
        [DataMember]
        public MemberNotificationSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    public class MemberNotificationSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<MemberNotificationPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<MemberNotificationPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<MemberNotificationPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<MemberNotificationPage> _pagesWindow;
        ...
        public MemberNotificationSet()
        {
            NameSpace = "dbo";
            //Name = "MemberNotifications " + StringResources.Table;
            Name = "MemberNotifications " + "Table";
            EntityName = "MemberNotification";
            //... other init
            _pages = new List<MemberNotificationPage>();
        }
    }
