...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "ShortMessageDataBlocks".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageDataBlockSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (AttachmentIDWrap != null ? AttachmentIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
        ...
        /// <summary>
        /// The wrapper for the AttachmentID key value.
        /// </summary>
        [DataMember]
        public ForeignKeyData<string> AttachmentIDWrap
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a limited set of available constraints of "ShortMessageDataBlocks".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageDataBlockSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public ShortMessageDataBlockSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "ShortMessageDataBlocks".
    /// </summary>
    [DataContract]
    [Serializable]
    public class ShortMessageDataBlockSet
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public List<ShortMessageDataBlockPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<ShortMessageDataBlockPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<ShortMessageDataBlockPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<ShortMessageDataBlockPage> _pagesWindow;
        ...
        public ShortMessageDataBlockSet()
        {
            NameSpace = "dbo";
            //Name = "ShortMessageDataBlocks " + StringResources.Table;
            Name = "ShortMessageDataBlocks " + "Table";
            EntityName = "ShortMessageDataBlock";
            //... other init
            _pages = new List<ShortMessageDataBlockPage>();
        }
    }
