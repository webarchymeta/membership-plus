...
{
    /// <summary>
    /// A structure representing possible combination of foreign key constraint of the data set of "Announcements".
    /// </summary>
    [DataContract]
    [Serializable]
    public class AnnouncementSetConstraints
    {
        /// <summary>
        /// internal use.
        /// </summary>
        public string CacheKey
        {
            ...
            {
                if (_cacheKey == null) 
                    _cacheKey = (ApplicationIDWrap != null ? ApplicationIDWrap.CacheKey : "" ) + "_" + (CreatedUserIDWrap != null ? CreatedUserIDWrap.CacheKey : "" ) + "_" + (GroupIDWrap != null ? GroupIDWrap.CacheKey : "" ) + "_"; 
                return _cacheKey;
            }
        }
    ...
    /// <summary>
    /// A structure representing a limited set of available constraints of "Announcements".
    /// </summary>
    [DataContract]
    [Serializable]
    public class AnnouncementSetConstraintsColl
    {
        /// <summary>
        /// Total number
        /// </summary>
        ...
        [DataMember]
        public AnnouncementSetConstraints[] AvailableOnes
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing the data set of "Announcements".
    /// </summary>
    [DataContract]
    [Serializable]
    public class AnnouncementSet
    {
        ...
        /// </summary>
        [DataMember]
        public List<AnnouncementPage> Pages
        {
            get { return _pages; }
            set { _pages = value; }
        }
        private List<AnnouncementPage> _pages;

        /// <summary>
        /// The displaying page block of the set.
        /// </summary>
        [DataMember]
        public List<AnnouncementPage> PagesWindow
        {
            get { return _pagesWindow; }
            set { _pagesWindow = value; }
        }
        private List<AnnouncementPage> _pagesWindow;
        ...
        {
            NameSpace = "dbo";
            //Name = "Announcements " + StringResources.Table;
            Name = "Announcements " + "Table";
            EntityName = "Announcement";
            //... other init
            _pages = new List<AnnouncementPage>();
        }
    }
