...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserProfileTypePageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserProfileTypePage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserProfileType" />.
    /// </summary>
    [DataContract]
    public class UserProfileTypePage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserProfileType FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserProfileType LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserProfileType> Items
        {
            get;
            set;
        }

        public UserProfileTypePage(int idx)
        {
            _index = idx;
        }
