...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class EventCalendarPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public EventCalendarPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="EventCalendar" />.
    /// </summary>
    [DataContract]
    public class EventCalendarPage
    {
        ...
        /// </summary>
        [DataMember]
        public EventCalendar FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<EventCalendar> Items
        {
            get;
            set;
        }

        public EventCalendarPage(int idx)
        {
            _index = idx;
        }
