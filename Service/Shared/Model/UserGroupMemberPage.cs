...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class UserGroupMemberPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupMemberPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserGroupMember" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class UserGroupMemberPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserGroupMember FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserGroupMember LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserGroupMember> Items
        {
            get;
            set;
        }

        public UserGroupMemberPage(int idx)
        {
            _index = idx;
        }
