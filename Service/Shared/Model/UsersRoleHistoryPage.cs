...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class UsersRoleHistoryPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UsersRoleHistoryPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UsersRoleHistory" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class UsersRoleHistoryPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UsersRoleHistory FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UsersRoleHistory LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UsersRoleHistory> Items
        {
            get;
            set;
        }

        public UsersRoleHistoryPage(int idx)
        {
            _index = idx;
        }
