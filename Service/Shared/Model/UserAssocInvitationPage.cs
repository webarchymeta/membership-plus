...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    /// </summary>
    [DataContract]
    public class UserAssocInvitationPageBlock
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssocInvitationPage[] Pages
        {
            get;
            set;
        }
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="UserAssocInvitation" />.
    /// </summary>
    [DataContract]
    public class UserAssocInvitationPage
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public UserAssocInvitation FirstItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        [DataMember]
        public UserAssocInvitation LastItem
        {
            get;
            set;
        }
        ...
        /// </summary>
        public List<UserAssocInvitation> Items
        {
            get;
            set;
        }

        public UserAssocInvitationPage(int idx)
        {
            _index = idx;
        }
