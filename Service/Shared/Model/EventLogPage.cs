...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    [DataContract]
    [Serializable]
    public class EventLogPageBlock
    {
        /// <summary>
    ...
    /// <summary>
    /// A structure representing a page of entity <see cref="EventLog" />.
    /// </summary>
    [DataContract]
    [Serializable]
    public class EventLogPage
    {
        ...
        /// </summary>
        public List<EventLog> Items
        {
            get;
            set;
        }

        public EventLogPage(int idx)
        {
            _index = idx;
        }
