...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.AddOrUpdateEntities" />, <see cref="IShortMessageAttachmentService.EnqueueNewOrUpdateEntities" />, and <see cref="IShortMessageAttachmentService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.NextPageBlock" /> and <see cref="IShortMessageAttachmentService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.QueryEntityCount" />, <see cref="IShortMessageAttachmentService.QueryDatabase" />, <see cref="IShortMessageAttachmentService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.LoadEntityByKey" /> and <see cref="IShortMessageAttachmentService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.ConstraintQueryEntityCount" />, <see cref="IShortMessageAttachmentService.ConstraintQuery" />, <see cref="IShortMessageAttachmentService.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService.GetNextSorterOps" /> and <see cref="IShortMessageAttachmentService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService.MaterializeShortMessageRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService.MaterializeShortMessageDataBlocks" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IShortMessageAttachmentService
    {
        /// <summary>
        ///   Retrieve information about the entity set: "ShortMessageAttachments". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="ShortMessageAttachmentSet" /> data model.
        /// </returns>
        [OperationContract]
        ...
        ShortMessageAttachmentSet GetSetInfo(CallContext cntx, string filter);

        /// <summary>
        ///   Get a block of page frames from the entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="ShortMessageAttachmentPageBlock" /> data model for entity set "ShortMessageAttachments".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        ShortMessageAttachmentPageBlock NextPageBlock(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, ShortMessageAttachment prevlast);

        /// <summary>
        ///   Load entities of a page from the entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="ShortMessageAttachment" /> in set "ShortMessageAttachments" for the current page defined by "prevlast".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        IEnumerable<ShortMessageAttachment> GetPageItems(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, ShortMessageAttachment prevlast);
        ...
        ///  <see cref="ShortMessageAttachment" />) is modified or its <see cref="ShortMessageAttachment.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ...
        ChangeOpResults<ShortMessageAttachmentUpdateResult> AddOrUpdateEntities(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);
        ...
        void EnqueueNewOrUpdateEntities(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);
        ...
        OperationResults DeleteEntities(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);

        /// <summary>
        ///   Count the number of entities inside entity set "ShortMessageAttachments" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        Int64 QueryEntityCount(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<ShortMessageAttachment> QueryDatabase(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<ShortMessageAttachment> QueryDatabaseLimited(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, int maxRecords);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        ...
        Int64 ConstraintQueryEntityCount(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ...
        ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints[] cnstSets, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<ShortMessageAttachment> ConstraintQuery(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<ShortMessageAttachment> ConstraintQueryLimited(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
        ...
        ShortMessage MaterializeShortMessageRef(CallContext cntx, ShortMessageAttachment entity);
        ...
        [WebInvoke(Method = "POST",
            ...
            ResponseFormat = WebMessageFormat.Json,
            BodyStyle = WebMessageBodyStyle.Wrapped,
            UriTemplate = "/MaterializeShortMessageDataBlocks")]
        ShortMessageDataBlockSet MaterializeShortMessageDataBlocks(CallContext cntx, ShortMessageAttachment entity);
        ...
        [WebInvoke(Method = "POST",
            ...
            ResponseFormat = WebMessageFormat.Json,
            BodyStyle = WebMessageBodyStyle.Wrapped,
            UriTemplate = "/MaterializeAllShortMessageDataBlocks")]
        IEnumerable<ShortMessageDataBlock> MaterializeAllShortMessageDataBlocks(CallContext cntx, ShortMessageAttachment entity);
        ...
        ShortMessageAttachment LoadEntityByKey(CallContext cntx, string _ID);

        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="ShortMessageAttachment.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageAttachment.ID" />.</param>
        ...
        ShortMessageAttachment LoadEntityGraphRecurs(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);

        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="ShortMessageAttachment.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="ShortMessageAttachment.ID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        List<ShortMessageAttachment> LoadEntityByNature(CallContext cntx, string _ID);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.AddOrUpdateEntities" />, <see cref="IShortMessageAttachmentService2.EnqueueNewOrUpdateEntities" />, and <see cref="IShortMessageAttachmentService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.NextPageBlock" /> and <see cref="IShortMessageAttachmentService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.QueryEntityCount" />, <see cref="IShortMessageAttachmentService2.QueryDatabase" />, <see cref="IShortMessageAttachmentService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.LoadEntityByKey" /> and <see cref="IShortMessageAttachmentService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.ConstraintQueryEntityCount" />, <see cref="IShortMessageAttachmentService2.ConstraintQuery" />, <see cref="IShortMessageAttachmentService2.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IShortMessageAttachmentService2.GetNextSorterOps" /> and <see cref="IShortMessageAttachmentService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService2.MaterializeShortMessageRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService2.MaterializeShortMessageDataBlocks" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IShortMessageAttachmentService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IShortMessageAttachmentService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "ShortMessageAttachments". 
        /// </summary>
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "ShortMessageAttachments". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessageAttachmentSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get a block of page frames from the entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessageAttachmentPageBlock> NextPageBlockAsync(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, ShortMessageAttachment prevlast);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load entities of a page from the entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageAttachment>> GetPageItemsAsync(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, ShortMessageAttachment prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<ShortMessageAttachmentUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachment[] entities);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "ShortMessageAttachments" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageAttachment>> QueryDatabaseAsync(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageAttachment>> QueryDatabaseLimitedAsync(CallContext cntx, ShortMessageAttachmentSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints[] cnstSets, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageAttachment>> ConstraintQueryAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageAttachment" /> inside entity set "ShortMessageAttachments" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "ShortMessageAttachments" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageAttachment>> ConstraintQueryLimitedAsync(CallContext cntx, ShortMessageAttachmentSet set, ShortMessageAttachmentSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessage> MaterializeShortMessageRefAsync(CallContext cntx, ShortMessageAttachment entity);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessageDataBlockSet> MaterializeShortMessageDataBlocksAsync(CallContext cntx, ShortMessageAttachment entity);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<ShortMessageDataBlock>> MaterializeAllShortMessageDataBlocksAsync(CallContext cntx, ShortMessageAttachment entity);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="ShortMessageAttachment.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageAttachment.ID" />.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessageAttachment> LoadEntityByKeyAsync(CallContext cntx, string _ID);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="ShortMessageAttachment.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageAttachment.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ShortMessageAttachment> LoadEntityGraphRecursAsync(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="ShortMessageAttachment.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="ShortMessageAttachment.ID" />.</param>
        /// <remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<List<ShortMessageAttachment>> LoadEntityByNatureAsync(CallContext cntx, string _ID);
#endif
