...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.AddOrUpdateEntities" />, <see cref="ISignalRMessageService.EnqueueNewOrUpdateEntities" />, and <see cref="ISignalRMessageService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.NextPageBlock" /> and <see cref="ISignalRMessageService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.QueryEntityCount" />, <see cref="ISignalRMessageService.QueryDatabase" />, <see cref="ISignalRMessageService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.LoadEntityByKey" /> and <see cref="ISignalRMessageService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.ConstraintQueryEntityCount" />, <see cref="ISignalRMessageService.ConstraintQuery" />, <see cref="ISignalRMessageService.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService.GetNextSorterOps" /> and <see cref="ISignalRMessageService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRMessageService.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRMessageService.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    ...
    {
        /// <summary>
        ///   Retrieve information about the entity set: "SignalRMessages". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="SignalRMessageSet" /> data model.
        /// </returns>
        [OperationContract]
        ...
        SignalRMessageSet GetSetInfo(CallContext cntx, string filter);

        /// <summary>
        ///   Get a block of page frames from the entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="SignalRMessagePageBlock" /> data model for entity set "SignalRMessages".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        SignalRMessagePageBlock NextPageBlock(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast);

        /// <summary>
        ///   Load entities of a page from the entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="SignalRMessage" /> in set "SignalRMessages" for the current page defined by "prevlast".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        IEnumerable<SignalRMessage> GetPageItems(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast);
        ...
        ///  <see cref="SignalRMessage" />) is modified or its <see cref="SignalRMessage.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="SignalRMessage.Application_Ref" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        ChangeOpResults<SignalRMessageUpdateResult> AddOrUpdateEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);
        ...
        void EnqueueNewOrUpdateEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);
        ...
        OperationResults DeleteEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);

        /// <summary>
        ///   Count the number of entities inside entity set "SignalRMessages" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        Int64 QueryEntityCount(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<SignalRMessage> QueryDatabase(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<SignalRMessage> QueryDatabaseLimited(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, int maxRecords);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        ...
        Int64 ConstraintQueryEntityCount(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ...
        ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints[] cnstSets, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<SignalRMessage> ConstraintQuery(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<SignalRMessage> ConstraintQueryLimited(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
        ...
        Application_ MaterializeApplication_Ref(CallContext cntx, SignalRMessage entity);

        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="SignalRMessage.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="SignalRMessage.ID" />.</param>
        /// <returns>
        ...
        SignalRMessage LoadEntityByKey(CallContext cntx, Int64 _ID);

        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="SignalRMessage.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="SignalRMessage.ID" />.</param>
        ...
        SignalRMessage LoadEntityGraphRecurs(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);

        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="SignalRMessage.TimeStamp" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_TimeStamp">Intrinsic id <see cref="SignalRMessage.TimeStamp" />.</param>
        /// <remarks>
        ///  <para>
        ...
        List<SignalRMessage> LoadEntityByNature(CallContext cntx, Int64 _TimeStamp);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.AddOrUpdateEntities" />, <see cref="ISignalRMessageService2.EnqueueNewOrUpdateEntities" />, and <see cref="ISignalRMessageService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.NextPageBlock" /> and <see cref="ISignalRMessageService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.QueryEntityCount" />, <see cref="ISignalRMessageService2.QueryDatabase" />, <see cref="ISignalRMessageService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.LoadEntityByKey" /> and <see cref="ISignalRMessageService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.ConstraintQueryEntityCount" />, <see cref="ISignalRMessageService2.ConstraintQuery" />, <see cref="ISignalRMessageService2.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRMessageService2.GetNextSorterOps" /> and <see cref="ISignalRMessageService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRMessageService2.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRMessageService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface ISignalRMessageService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "SignalRMessages". 
        /// </summary>
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "SignalRMessages". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRMessageSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get a block of page frames from the entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRMessagePageBlock> NextPageBlockAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load entities of a page from the entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> GetPageItemsAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<SignalRMessageUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "SignalRMessages" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> QueryDatabaseAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> QueryDatabaseLimitedAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints[] cnstSets, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> ConstraintQueryAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRMessage" /> inside entity set "SignalRMessages" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRMessages" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> ConstraintQueryLimitedAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, SignalRMessage entity);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="SignalRMessage.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="SignalRMessage.ID" />.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRMessage> LoadEntityByKeyAsync(CallContext cntx, Int64 _ID);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="SignalRMessage.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="SignalRMessage.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRMessage> LoadEntityGraphRecursAsync(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="SignalRMessage.TimeStamp" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_TimeStamp">Intrinsic id <see cref="SignalRMessage.TimeStamp" />.</param>
        /// <remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<List<SignalRMessage>> LoadEntityByNatureAsync(CallContext cntx, Int64 _TimeStamp);
#endif
