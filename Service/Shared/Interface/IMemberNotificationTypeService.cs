...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService.AddOrUpdateEntities" />, <see cref="IMemberNotificationTypeService.EnqueueNewOrUpdateEntities" />, and <see cref="IMemberNotificationTypeService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService.NextPageBlock" /> and <see cref="IMemberNotificationTypeService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService.QueryEntityCount" />, <see cref="IMemberNotificationTypeService.QueryDatabase" />, <see cref="IMemberNotificationTypeService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService.LoadEntityByKey" /> and <see cref="IMemberNotificationTypeService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService.GetNextSorterOps" /> and <see cref="IMemberNotificationTypeService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IMemberNotificationTypeService.MaterializeMemberNotifications" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IMemberNotificationTypeService.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IMemberNotificationTypeService
    {
        /// <summary>
        ///   Retrieve information about the entity set: "MemberNotificationTypes". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="MemberNotificationTypeSet" /> data model.
        /// </returns>
        [OperationContract]
        ...
        MemberNotificationTypeSet GetSetInfo(CallContext cntx, string filter);

        /// <summary>
        ///   Get a block of page frames from the entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="MemberNotificationTypePageBlock" /> data model for entity set "MemberNotificationTypes".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        MemberNotificationTypePageBlock NextPageBlock(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast);

        /// <summary>
        ///   Load entities of a page from the entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="MemberNotificationType" /> in set "MemberNotificationTypes" for the current page defined by "prevlast".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        IEnumerable<MemberNotificationType> GetPageItems(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast);
        ...
        ///  <see cref="MemberNotificationType" />) is modified or its <see cref="MemberNotificationType.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can also create and add to member collections in { <see cref="MemberNotificationType.ChangedMemberNotifications" /> } entities that depends on an currently added or updated entity. These 
        ...
        ChangeOpResults<MemberNotificationTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);
        ...
        void EnqueueNewOrUpdateEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);
        ...
        OperationResults DeleteEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);

        /// <summary>
        ///   Count the number of entities inside entity set "MemberNotificationTypes" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        Int64 QueryEntityCount(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="MemberNotificationType" /> inside entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<MemberNotificationType> QueryDatabase(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="MemberNotificationType" /> inside entity set "MemberNotificationTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<MemberNotificationType> QueryDatabaseLimited(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, int maxRecords);
        ...
        MemberNotificationSet MaterializeMemberNotifications(CallContext cntx, MemberNotificationType entity);
        ...
        IEnumerable<MemberNotification> MaterializeAllMemberNotifications(CallContext cntx, MemberNotificationType entity);

        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="MemberNotificationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="MemberNotificationType.ID" />.</param>
        /// <returns>
        ...
        MemberNotificationType LoadEntityByKey(CallContext cntx, int _ID);

        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="MemberNotificationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="MemberNotificationType.ID" />.</param>
        ...
        MemberNotificationType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);

        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="MemberNotificationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="MemberNotificationType.ID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        List<MemberNotificationType> LoadEntityByNature(CallContext cntx, int _ID);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService2.AddOrUpdateEntities" />, <see cref="IMemberNotificationTypeService2.EnqueueNewOrUpdateEntities" />, and <see cref="IMemberNotificationTypeService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService2.NextPageBlock" /> and <see cref="IMemberNotificationTypeService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService2.QueryEntityCount" />, <see cref="IMemberNotificationTypeService2.QueryDatabase" />, <see cref="IMemberNotificationTypeService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService2.LoadEntityByKey" /> and <see cref="IMemberNotificationTypeService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IMemberNotificationTypeService2.GetNextSorterOps" /> and <see cref="IMemberNotificationTypeService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IMemberNotificationTypeService2.MaterializeMemberNotifications" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IMemberNotificationTypeService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IMemberNotificationTypeService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "MemberNotificationTypes". 
        /// </summary>
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "MemberNotificationTypes". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<MemberNotificationTypeSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get a block of page frames from the entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<MemberNotificationTypePageBlock> NextPageBlockAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load entities of a page from the entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> GetPageItemsAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<MemberNotificationTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "MemberNotificationTypes" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="MemberNotificationType" /> inside entity set "MemberNotificationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> QueryDatabaseAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="MemberNotificationType" /> inside entity set "MemberNotificationTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> QueryDatabaseLimitedAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<MemberNotificationSet> MaterializeMemberNotificationsAsync(CallContext cntx, MemberNotificationType entity);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<MemberNotification>> MaterializeAllMemberNotificationsAsync(CallContext cntx, MemberNotificationType entity);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="MemberNotificationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="MemberNotificationType.ID" />.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<MemberNotificationType> LoadEntityByKeyAsync(CallContext cntx, int _ID);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="MemberNotificationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="MemberNotificationType.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<MemberNotificationType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="MemberNotificationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="MemberNotificationType.ID" />.</param>
        /// <remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<List<MemberNotificationType>> LoadEntityByNatureAsync(CallContext cntx, int _ID);
#endif
