...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.AddOrUpdateEntities" />, <see cref="ISignalRHostStateService.EnqueueNewOrUpdateEntities" />, and <see cref="ISignalRHostStateService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.NextPageBlock" /> and <see cref="ISignalRHostStateService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.QueryEntityCount" />, <see cref="ISignalRHostStateService.QueryDatabase" />, <see cref="ISignalRHostStateService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.LoadEntityByKey" /> and <see cref="ISignalRHostStateService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.ConstraintQueryEntityCount" />, <see cref="ISignalRHostStateService.ConstraintQuery" />, <see cref="ISignalRHostStateService.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService.GetNextSorterOps" /> and <see cref="ISignalRHostStateService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRHostStateService.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    public interface ISignalRHostStateService
    {
        ...
        /// <returns>
        ///   Entity set: <see cref="SignalRHostStateSet" /> data model.
        /// </returns>
        [OperationContract]
        ...
        SignalRHostStateSet GetSetInfo(CallContext cntx, string filter);

        /// <summary>
        ///   Get a block of page frames from the entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="SignalRHostStatePageBlock" /> data model for entity set "SignalRHostStates".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        SignalRHostStatePageBlock NextPageBlock(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast);

        /// <summary>
        ///   Load entities of a page from the entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="SignalRHostState" /> in set "SignalRHostStates" for the current page defined by "prevlast".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        IEnumerable<SignalRHostState> GetPageItems(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast);
        ...
        ///  <see cref="SignalRHostState" />) is modified or its <see cref="SignalRHostState.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="SignalRHostState.Application_Ref" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        ChangeOpResults<SignalRHostStateUpdateResult> AddOrUpdateEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);
        ...
        void EnqueueNewOrUpdateEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);
        ...
        OperationResults DeleteEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);

        /// <summary>
        ///   Count the number of entities inside entity set "SignalRHostStates" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        Int64 QueryEntityCount(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<SignalRHostState> QueryDatabase(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<SignalRHostState> QueryDatabaseLimited(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, int maxRecords);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        ...
        Int64 ConstraintQueryEntityCount(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ...
        ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints[] cnstSets, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<SignalRHostState> ConstraintQuery(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<SignalRHostState> ConstraintQueryLimited(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.AddOrUpdateEntities" />, <see cref="ISignalRHostStateService2.EnqueueNewOrUpdateEntities" />, and <see cref="ISignalRHostStateService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.NextPageBlock" /> and <see cref="ISignalRHostStateService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.QueryEntityCount" />, <see cref="ISignalRHostStateService2.QueryDatabase" />, <see cref="ISignalRHostStateService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.LoadEntityByKey" /> and <see cref="ISignalRHostStateService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.ConstraintQueryEntityCount" />, <see cref="ISignalRHostStateService2.ConstraintQuery" />, <see cref="ISignalRHostStateService2.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ISignalRHostStateService2.GetNextSorterOps" /> and <see cref="ISignalRHostStateService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRHostStateService2.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ISignalRHostStateService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface ISignalRHostStateService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "SignalRHostStates". 
        /// </summary>
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "SignalRHostStates". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRHostStateSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get a block of page frames from the entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<SignalRHostStatePageBlock> NextPageBlockAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load entities of a page from the entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> GetPageItemsAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<SignalRHostStateUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "SignalRHostStates" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> QueryDatabaseAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> QueryDatabaseLimitedAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints[] cnstSets, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> ConstraintQueryAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="SignalRHostState" /> inside entity set "SignalRHostStates" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "SignalRHostStates" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> ConstraintQueryLimitedAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, SignalRHostState entity);
#endif
