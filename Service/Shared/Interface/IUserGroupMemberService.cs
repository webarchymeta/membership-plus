...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.AddOrUpdateEntities" />, <see cref="IUserGroupMemberService.EnqueueNewOrUpdateEntities" />, and <see cref="IUserGroupMemberService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.NextPageBlock" /> and <see cref="IUserGroupMemberService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.QueryEntityCount" />, <see cref="IUserGroupMemberService.QueryDatabase" />, <see cref="IUserGroupMemberService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.LoadEntityByKey" /> and <see cref="IUserGroupMemberService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.ConstraintQueryEntityCount" />, <see cref="IUserGroupMemberService.ConstraintQuery" />, <see cref="IUserGroupMemberService.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService.GetNextSorterOps" /> and <see cref="IUserGroupMemberService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserGroupMemberService.MaterializeUserGroupRef" />, <see cref="IUserGroupMemberService.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserGroupMemberService.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    ...
    public interface IUserGroupMemberService
    {
        ...
        UserGroupMemberSet GetSetInfo(CallContext cntx, string filter);
        ...
        UserGroupMemberPageBlock NextPageBlock(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, UserGroupMember prevlast);
        ...
        IEnumerable<UserGroupMember> GetPageItems(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, UserGroupMember prevlast);
        ...
        ChangeOpResults<UserGroupMemberUpdateResult> AddOrUpdateEntities(CallContext cntx, UserGroupMemberSet set, UserGroupMember[] entities);
        ...
        Int64 QueryEntityCount(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr);
        ...
        IEnumerable<UserGroupMember> QueryDatabase(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr);
        ...
        IEnumerable<UserGroupMember> QueryDatabaseLimited(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, int maxRecords);
        ...
        Int64 ConstraintQueryEntityCount(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr);
        ...
        ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints[] cnstSets, QueryExpresion qexpr);
        ...
        IEnumerable<UserGroupMember> ConstraintQuery(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr);
        ...
        IEnumerable<UserGroupMember> ConstraintQueryLimited(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
        ...
        UserGroup MaterializeUserGroupRef(CallContext cntx, UserGroupMember entity);
        ...
        User MaterializeUserRef(CallContext cntx, UserGroupMember entity);
        ...
        UserGroupMemberSetConstraintsColl QuerySetConstraints(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, int max, string nextId);
        ...
        UserGroupMember LoadEntityByKey(CallContext cntx, string _UserGroupID, string _UserID);
        ...
        UserGroupMember LoadEntityGraphRecurs(CallContext cntx, string _UserGroupID, string _UserID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
        ...
        List<UserGroupMember> LoadEntityByNature(CallContext cntx, string _UserGroupID, string _UserID);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.AddOrUpdateEntities" />, <see cref="IUserGroupMemberService2.EnqueueNewOrUpdateEntities" />, and <see cref="IUserGroupMemberService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.NextPageBlock" /> and <see cref="IUserGroupMemberService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.QueryEntityCount" />, <see cref="IUserGroupMemberService2.QueryDatabase" />, <see cref="IUserGroupMemberService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.LoadEntityByKey" /> and <see cref="IUserGroupMemberService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.ConstraintQueryEntityCount" />, <see cref="IUserGroupMemberService2.ConstraintQuery" />, <see cref="IUserGroupMemberService2.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserGroupMemberService2.GetNextSorterOps" /> and <see cref="IUserGroupMemberService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserGroupMemberService2.MaterializeUserGroupRef" />, <see cref="IUserGroupMemberService2.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserGroupMemberService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IUserGroupMemberService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "UserGroupMembers". 
        /// </summary>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroupMemberSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroupMemberPageBlock> NextPageBlockAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, UserGroupMember prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserGroupMember>> GetPageItemsAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, UserGroupMember prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<UserGroupMemberUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserGroupMemberSet set, UserGroupMember[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserGroupMember>> QueryDatabaseAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserGroupMember>> QueryDatabaseLimitedAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints[] cnstSets, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserGroupMember>> ConstraintQueryAsync(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserGroupMember>> ConstraintQueryLimitedAsync(CallContext cntx, UserGroupMemberSet set, UserGroupMemberSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroup> MaterializeUserGroupRefAsync(CallContext cntx, UserGroupMember entity);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, UserGroupMember entity);
#endif
        ...
        /// <remarks>It will throw an exception if the <see cref="UserGroupMemberSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroupMemberSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserGroupMemberSet set, QueryExpresion qexpr, int max, string nextId);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroupMember> LoadEntityByKeyAsync(CallContext cntx, string _UserGroupID, string _UserID);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserGroupMember> LoadEntityGraphRecursAsync(CallContext cntx, string _UserGroupID, string _UserID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<List<UserGroupMember>> LoadEntityByNatureAsync(CallContext cntx, string _UserGroupID, string _UserID);
#endif
