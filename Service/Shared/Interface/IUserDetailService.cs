...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.AddOrUpdateEntities" />, <see cref="IUserDetailService.EnqueueNewOrUpdateEntities" />, and <see cref="IUserDetailService.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.NextPageBlock" /> and <see cref="IUserDetailService.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.QueryEntityCount" />, <see cref="IUserDetailService.QueryDatabase" />, <see cref="IUserDetailService.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.LoadEntityByKey" /> and <see cref="IUserDetailService.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.ConstraintQueryEntityCount" />, <see cref="IUserDetailService.ConstraintQuery" />, <see cref="IUserDetailService.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService.GetNextSorterOps" /> and <see cref="IUserDetailService.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="IUserDetailService.LoadEntityDescription" />, <see cref="IUserDetailService.LoadEntityPhoto" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="IUserDetailService.UpdateEntityDescription" />, <see cref="IUserDetailService.UpdateEntityPhoto" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserDetailService.MaterializeApplication_Ref" />, <see cref="IUserDetailService.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserDetailService.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    ...
    public interface IUserDetailService
    {
        ...
        /// <returns>
        ///   Entity set: <see cref="UserDetailSet" /> data model.
        /// </returns>
        [OperationContract]
        ...
        UserDetailSet GetSetInfo(CallContext cntx, string filter);

        /// <summary>
        ///   Get a block of page frames from the entity set "UserDetails" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="UserDetailPageBlock" /> data model for entity set "UserDetails".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        UserDetailPageBlock NextPageBlock(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast);

        /// <summary>
        ///   Load entities of a page from the entity set "UserDetails" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="UserDetail" /> in set "UserDetails" for the current page defined by "prevlast".
        /// </returns>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
        ...
        IEnumerable<UserDetail> GetPageItems(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast);
        ...
        ///  <see cref="UserDetail" />) is modified or its <see cref="UserDetail.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserDetail.Application_Ref" />, <see cref="UserDetail.UserRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        ChangeOpResults<UserDetailUpdateResult> AddOrUpdateEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities);
        ...
        void EnqueueNewOrUpdateEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities);
        ...
        OperationResults DeleteEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities);

        /// <summary>
        ///   Count the number of entities inside entity set "UserDetails" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        Int64 QueryEntityCount(CallContext cntx, UserDetailSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<UserDetail> QueryDatabase(CallContext cntx, UserDetailSet set, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        IEnumerable<UserDetail> QueryDatabaseLimited(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int maxRecords);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        ...
        Int64 ConstraintQueryEntityCount(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr);
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ...
        ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UserDetailSet set, UserDetailSetConstraints[] cnstSets, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<UserDetail> ConstraintQuery(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr);

        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        IEnumerable<UserDetail> ConstraintQueryLimited(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
        ...
        Application_ MaterializeApplication_Ref(CallContext cntx, UserDetail entity);
        ...
        User MaterializeUserRef(CallContext cntx, UserDetail entity);

        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserDetailSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        [OperationContract]
        [WebInvoke(Method = "POST",
            RequestFormat = WebMessageFormat.Json,
            ResponseFormat = WebMessageFormat.Json,
        ...
        UserDetailSetConstraintsColl QuerySetConstraints(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int max, string nextId);
        ...
        UserDetail LoadEntityByKey(CallContext cntx, string _ApplicationID, string _UserID);
        ...
        UserDetail LoadEntityGraphRecurs(CallContext cntx, string _ApplicationID, string _UserID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);

        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserDetail.ApplicationID" />, <see cref="UserDetail.UserID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ApplicationID">Intrinsic id <see cref="UserDetail.ApplicationID" />.</param>
        ...
        List<UserDetail> LoadEntityByNature(CallContext cntx, string _ApplicationID, string _UserID);
        ...
        string LoadEntityDescription(CallContext cntx, string _ApplicationID, string _UserID);
        ...
        void UpdateEntityDescription(CallContext cntx, string _ApplicationID, string _UserID, string data);
        ...
        [WebInvoke(Method = "POST",
            ...
            ResponseFormat = WebMessageFormat.Json,
            BodyStyle = WebMessageBodyStyle.Wrapped,
            UriTemplate = "/LoadEntityPhoto")]
        byte[] LoadEntityPhoto(CallContext cntx, string _ApplicationID, string _UserID);
        ...
        [WebInvoke(Method = "POST",
            ...
            ResponseFormat = WebMessageFormat.Json,
            BodyStyle = WebMessageBodyStyle.Wrapped,
            UriTemplate = "/UpdateEntityPhoto")]
        void UpdateEntityPhoto(CallContext cntx, string _ApplicationID, string _UserID, System.Nullable<DateTime> _PhotoLastModified, string _PhotoMime, byte[] data);
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.AddOrUpdateEntities" />, <see cref="IUserDetailService2.EnqueueNewOrUpdateEntities" />, and <see cref="IUserDetailService2.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.NextPageBlock" /> and <see cref="IUserDetailService2.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.QueryEntityCount" />, <see cref="IUserDetailService2.QueryDatabase" />, <see cref="IUserDetailService2.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.LoadEntityByKey" /> and <see cref="IUserDetailService2.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.ConstraintQueryEntityCount" />, <see cref="IUserDetailService2.ConstraintQuery" />, <see cref="IUserDetailService2.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.GetNextSorterOps" /> and <see cref="IUserDetailService2.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods (loading)</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.LoadEntityDescription" />, <see cref="IUserDetailService2.LoadEntityPhoto" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="IUserDetailService2.UpdateEntityDescription" />, <see cref="IUserDetailService2.UpdateEntityPhoto" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserDetailService2.MaterializeApplication_Ref" />, <see cref="IUserDetailService2.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="IUserDetailService2.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    [ServiceContract(Namespace = "http://relationaldb.archymeta.com/MembershipPlus/", SessionMode = SessionMode.Allowed)]
    public interface IUserDetailService2
    {
        /// <summary>
        ///   Retrieve information about the entity set: "UserDetails". 
        /// </summary>
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "UserDetails". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserDetailSet> GetSetInfoAsync(CallContext cntx, string filter);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get a block of page frames from the entity set "UserDetails" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserDetailPageBlock> NextPageBlockAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load entities of a page from the entity set "UserDetails" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserDetail>> GetPageItemsAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ChangeOpResults<UserDetailUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "UserDetails" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserDetail>> QueryDatabaseAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserDetail>> QueryDatabaseLimitedAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints[] cnstSets, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserDetail>> ConstraintQueryAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserDetails" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<IEnumerable<UserDetail>> ConstraintQueryLimitedAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr, int maxRecords);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, UserDetail entity);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, UserDetail entity);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UserDetail" /> inside entity set "UserDetails" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Filter expression for the set.</param>
        ...
        /// <remarks>It will throw an exception if the <see cref="UserDetailSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        [OperationContract]
        System.Threading.Tasks.Task<UserDetailSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int max, string nextId);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserDetail> LoadEntityByKeyAsync(CallContext cntx, string _ApplicationID, string _UserID);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<UserDetail> LoadEntityGraphRecursAsync(CallContext cntx, string _ApplicationID, string _UserID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets);
#endif
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserDetail.ApplicationID" />, <see cref="UserDetail.UserID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ApplicationID">Intrinsic id <see cref="UserDetail.ApplicationID" />.</param>
        /// <param name="_UserID">Intrinsic id <see cref="UserDetail.UserID" />.</param>
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<List<UserDetail>> LoadEntityByNatureAsync(CallContext cntx, string _ApplicationID, string _UserID);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<string> LoadEntityDescriptionAsync(CallContext cntx, string _ApplicationID, string _UserID);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task UpdateEntityDescriptionAsync(CallContext cntx, string _ApplicationID, string _UserID, string data);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task<byte[]> LoadEntityPhotoAsync(CallContext cntx, string _ApplicationID, string _UserID);
#endif
        ...
        /// </returns>
        [OperationContract]
        System.Threading.Tasks.Task UpdateEntityPhotoAsync(CallContext cntx, string _ApplicationID, string _UserID, System.Nullable<DateTime> _PhotoLastModified, string _PhotoMime, byte[] data);
#endif
