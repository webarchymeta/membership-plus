...
{
    /// <summary>
    /// Proxy for <see cref="ISignalRMessageService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.AddOrUpdateEntities" />, <see cref="SignalRMessageServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="SignalRMessageServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.NextPageBlock" /> and <see cref="SignalRMessageServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.QueryEntityCount" />, <see cref="SignalRMessageServiceProxy.QueryDatabase" />, <see cref="SignalRMessageServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.LoadEntityByKey" /> and <see cref="SignalRMessageServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.ConstraintQueryEntityCount" />, <see cref="SignalRMessageServiceProxy.ConstraintQuery" />, <see cref="SignalRMessageServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRMessageServiceProxy.GetNextSorterOps" /> and <see cref="SignalRMessageServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="SignalRMessageServiceProxy.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="SignalRMessageServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class SignalRMessageServiceProxy : ClientBase<ISignalRMessageService2>, ISignalRMessageService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public SignalRMessageServiceProxy() 
            : base("HTTP")
        {
        ...
        public SignalRMessageServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public SignalRMessageServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public SignalRMessageSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="SignalRMessageSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRMessageSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<SignalRMessageUpdateResult> AddOrUpdateEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<SignalRMessageUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessage[] entities)
        {
            try
            {
        ...
        /// </returns>
        public SignalRMessagePageBlock NextPageBlock(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="SignalRMessagePageBlock" /> data model for entity set "SignalRMessages".
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRMessagePageBlock> NextPageBlockAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<SignalRMessage> GetPageItems(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="SignalRMessage" /> in set "SignalRMessages" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> GetPageItemsAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, SignalRMessage prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<SignalRMessage> QueryDatabase(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> QueryDatabaseAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRMessage> QueryDatabaseLimited(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> QueryDatabaseLimitedAsync(CallContext cntx, SignalRMessageSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRMessage> ConstraintQuery(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> ConstraintQueryAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRMessage> ConstraintQueryLimited(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRMessage>> ConstraintQueryLimitedAsync(CallContext cntx, SignalRMessageSet set, SignalRMessageSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, SignalRMessage entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, SignalRMessage entity)
        {
            try
            {
        ...
        /// </returns>
        public SignalRMessage LoadEntityByKey(CallContext cntx, Int64 _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRMessage> LoadEntityByKeyAsync(CallContext cntx, Int64 _ID)
        {
            try
            {
        ...
        /// </returns>
        public SignalRMessage LoadEntityGraphRecurs(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRMessage> LoadEntityGraphRecursAsync(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<SignalRMessage> LoadEntityByNature(CallContext cntx, Int64 _TimeStamp)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _TimeStamp);
        ...
        ///   The list of found entities.
        /// </returns>
        public async System.Threading.Tasks.Task<List<SignalRMessage>> LoadEntityByNatureAsync(CallContext cntx, Int64 _TimeStamp)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _TimeStamp);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
