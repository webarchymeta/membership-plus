...
{
    /// <summary>
    /// Proxy for <see cref="IUserAssociationService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.AddOrUpdateEntities" />, <see cref="UserAssociationServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserAssociationServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.NextPageBlock" /> and <see cref="UserAssociationServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.QueryEntityCount" />, <see cref="UserAssociationServiceProxy.QueryDatabase" />, <see cref="UserAssociationServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.LoadEntityByKey" /> and <see cref="UserAssociationServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.ConstraintQueryEntityCount" />, <see cref="UserAssociationServiceProxy.ConstraintQuery" />, <see cref="UserAssociationServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationServiceProxy.GetNextSorterOps" /> and <see cref="UserAssociationServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserAssociationServiceProxy.MaterializeUserAssociationTypeRef" />, <see cref="UserAssociationServiceProxy.MaterializeUser_FromUserID" />, <see cref="UserAssociationServiceProxy.MaterializeUser_ToUserID" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserAssociationServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserAssociationServiceProxy : ClientBase<IUserAssociationService2>, IUserAssociationService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UserAssociationServiceProxy() 
            : base("HTTP")
        {
        ...
        public UserAssociationServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserAssociationServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <returns>
        ///   Entity set: <see cref="UserAssociationSet" /> data model.
        /// </returns>
        public UserAssociationSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "UserAssociations". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="UserAssociationSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="UserAssociation" />) is modified or its <see cref="UserAssociation.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserAssociation.UserAssociationTypeRef" />, <see cref="UserAssociation.User_FromUserID" />, <see cref="UserAssociation.User_ToUserID" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// </returns>
        public ChangeOpResults<UserAssociationUpdateResult> AddOrUpdateEntities(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserAssociationUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserAssociationSet set, UserAssociation[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserAssociations" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="UserAssociationPageBlock" /> data model for entity set "UserAssociations".
        /// </returns>
        public UserAssociationPageBlock NextPageBlock(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, UserAssociation prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserAssociations" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="UserAssociationPageBlock" /> data model for entity set "UserAssociations".
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationPageBlock> NextPageBlockAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, UserAssociation prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserAssociations" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="UserAssociation" /> in set "UserAssociations" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<UserAssociation> GetPageItems(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, UserAssociation prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserAssociations" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="UserAssociation" /> in set "UserAssociations" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> GetPageItemsAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, UserAssociation prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "UserAssociations" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "UserAssociations" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<UserAssociation> QueryDatabase(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> QueryDatabaseAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserAssociation> QueryDatabaseLimited(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> QueryDatabaseLimitedAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserAssociation> ConstraintQuery(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> ConstraintQueryAsync(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserAssociation> ConstraintQueryLimited(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UserAssociations" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> ConstraintQueryLimitedAsync(CallContext cntx, UserAssociationSet set, UserAssociationSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public UserAssociationType MaterializeUserAssociationTypeRef(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="UserAssociationType" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationType> MaterializeUserAssociationTypeRefAsync(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        /// </returns>
        public User MaterializeUser_FromUserID(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_FromUserIDAsync(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public User MaterializeUser_ToUserID(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_ToUserIDAsync(CallContext cntx, UserAssociation entity)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserAssociationSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public UserAssociationSetConstraintsColl QuerySetConstraints(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UserAssociation" /> inside entity set "UserAssociations" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Filter expression for the set.</param>
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserAssociationSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<UserAssociationSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserAssociationSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        ...
        /// </returns>
        public UserAssociation LoadEntityByKey(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_FromUserID">Primary key <see cref="UserAssociation.FromUserID" />.</param>
        /// <param name="_ToUserID">Primary key <see cref="UserAssociation.ToUserID" />.</param>
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociation> LoadEntityByKeyAsync(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_FromUserID">Primary key <see cref="UserAssociation.FromUserID" />.</param>
        /// <param name="_ToUserID">Primary key <see cref="UserAssociation.ToUserID" />.</param>
        ...
        /// </returns>
        public UserAssociation LoadEntityGraphRecurs(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
                return Channel.LoadEntityGraphRecurs(cntx, _FromUserID, _ToUserID, _TypeID, excludedSets, futherDrillSets);
            }
            catch (Exception ex)
            {
                HandleError(ex);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_FromUserID">Primary key <see cref="UserAssociation.FromUserID" />.</param>
        /// <param name="_ToUserID">Primary key <see cref="UserAssociation.ToUserID" />.</param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociation> LoadEntityGraphRecursAsync(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
                return await Channel.LoadEntityGraphRecursAsync(cntx, _FromUserID, _ToUserID, _TypeID, excludedSets, futherDrillSets);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_FromUserID">Intrinsic id <see cref="UserAssociation.FromUserID" />.</param>
        /// <param name="_ToUserID">Intrinsic id <see cref="UserAssociation.ToUserID" />.</param>
        /// <param name="_TypeID">Intrinsic id <see cref="UserAssociation.TypeID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<UserAssociation> LoadEntityByNature(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserAssociation.FromUserID" />, <see cref="UserAssociation.ToUserID" />, <see cref="UserAssociation.TypeID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_FromUserID">Intrinsic id <see cref="UserAssociation.FromUserID" />.</param>
        /// <param name="_ToUserID">Intrinsic id <see cref="UserAssociation.ToUserID" />.</param>
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserAssociation>> LoadEntityByNatureAsync(CallContext cntx, string _FromUserID, string _ToUserID, int _TypeID)
        {
            try
            {
