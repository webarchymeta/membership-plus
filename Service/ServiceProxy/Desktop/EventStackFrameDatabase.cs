...
{
    /// <summary>
    /// Proxy for <see cref="IEventStackFrameService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.AddOrUpdateEntities" />, <see cref="EventStackFrameServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="EventStackFrameServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.NextPageBlock" /> and <see cref="EventStackFrameServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.QueryEntityCount" />, <see cref="EventStackFrameServiceProxy.QueryDatabase" />, <see cref="EventStackFrameServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.LoadEntityByKey" /> and <see cref="EventStackFrameServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.ConstraintQueryEntityCount" />, <see cref="EventStackFrameServiceProxy.ConstraintQuery" />, <see cref="EventStackFrameServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.GetNextSorterOps" /> and <see cref="EventStackFrameServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="EventStackFrameServiceProxy.LoadEntityFullInfo" />
    ///      </description>
    ///    </item>
    ///    <item>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventStackFrameServiceProxy.MaterializeEventLocationRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventStackFrameServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class EventStackFrameServiceProxy : ClientBase<IEventStackFrameService2>, IEventStackFrameService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public EventStackFrameServiceProxy() 
            : base("HTTP")
        {
        ...
        public EventStackFrameServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public EventStackFrameServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "EventStackFrames". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="EventStackFrameSet" /> data model.
        /// </returns>
        public EventStackFrameSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "EventStackFrames". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="EventStackFrameSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<EventStackFrameSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="EventStackFrame" />) is modified or its <see cref="EventStackFrame.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="EventStackFrame.EventLocationRef" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// </returns>
        public ChangeOpResults<EventStackFrameUpdateResult> AddOrUpdateEntities(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<EventStackFrameUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, EventStackFrameSet set, EventStackFrame[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="EventStackFramePageBlock" /> data model for entity set "EventStackFrames".
        /// </returns>
        public EventStackFramePageBlock NextPageBlock(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, EventStackFrame prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="EventStackFramePageBlock" /> data model for entity set "EventStackFrames".
        /// </returns>
        public async System.Threading.Tasks.Task<EventStackFramePageBlock> NextPageBlockAsync(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, EventStackFrame prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="EventStackFrame" /> in set "EventStackFrames" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<EventStackFrame> GetPageItems(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, EventStackFrame prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="EventStackFrame" /> in set "EventStackFrames" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventStackFrame>> GetPageItemsAsync(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, EventStackFrame prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "EventStackFrames" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "EventStackFrames" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<EventStackFrame> QueryDatabase(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventStackFrame>> QueryDatabaseAsync(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventStackFrame> QueryDatabaseLimited(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventStackFrame>> QueryDatabaseLimitedAsync(CallContext cntx, EventStackFrameSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventStackFrame> ConstraintQuery(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventStackFrame>> ConstraintQueryAsync(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventStackFrame> ConstraintQueryLimited(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventStackFrame" /> inside entity set "EventStackFrames" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "EventStackFrames" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventStackFrame>> ConstraintQueryLimitedAsync(CallContext cntx, EventStackFrameSet set, EventStackFrameSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// <summary>
        ///   Load the entity "EventLocationRef" of type <see cref="EventLocation" /> that the entity depend upon. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        ...
        /// </remarks>
        /// <returns>
        ///   An entity of type <see cref="EventLocation" /> or null.
        /// </returns>
        public EventLocation MaterializeEventLocationRef(CallContext cntx, EventStackFrame entity)
        {
            try
            {
                var e = Channel.MaterializeEventLocationRef(cntx, entity.ShallowCopy()); 
                if (e != null)
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load the entity "EventLocationRef" of type <see cref="EventLocation" /> that the entity depend upon. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <remarks>
        ...
        ///   An entity of type <see cref="EventLocation" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<EventLocation> MaterializeEventLocationRefAsync(CallContext cntx, EventStackFrame entity)
        {
            try
            {
                var e = await Channel.MaterializeEventLocationRefAsync(cntx, entity.ShallowCopy());
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public EventStackFrame LoadEntityByKey(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                var e = Channel.LoadEntityByKey(cntx, _ID, _EventID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventStackFrame> LoadEntityByKeyAsync(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                var e = await Channel.LoadEntityByKeyAsync(cntx, _ID, _EventID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        ...
        /// </returns>
        public EventStackFrame LoadEntityGraphRecurs(CallContext cntx, int _ID, string _EventID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
                return Channel.LoadEntityGraphRecurs(cntx, _ID, _EventID, excludedSets, futherDrillSets);
            }
            catch (Exception ex)
            {
                HandleError(ex);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventStackFrame> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, string _EventID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
                return await Channel.LoadEntityGraphRecursAsync(cntx, _ID, _EventID, excludedSets, futherDrillSets);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Intrinsic id <see cref="EventStackFrame.EventID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<EventStackFrame> LoadEntityByNature(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _ID, _EventID);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="EventStackFrame.ID" />, <see cref="EventStackFrame.EventID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Intrinsic id <see cref="EventStackFrame.EventID" />.</param>
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<EventStackFrame>> LoadEntityByNatureAsync(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _ID, _EventID);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        ///  Load the delay loaded property <see cref="EventStackFrame.FullInfo" />. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        ...
        /// </returns>
        public string LoadEntityFullInfo(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                return Channel.LoadEntityFullInfo(cntx, _ID, _EventID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load the delay loaded property <see cref="EventStackFrame.FullInfo" />. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventStackFrame.ID" />.</param>
        /// <param name="_EventID">Primary key <see cref="EventStackFrame.EventID" />.</param>
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<string> LoadEntityFullInfoAsync(CallContext cntx, int _ID, string _EventID)
        {
            try
            {
                return await Channel.LoadEntityFullInfoAsync(cntx, _ID, _EventID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
