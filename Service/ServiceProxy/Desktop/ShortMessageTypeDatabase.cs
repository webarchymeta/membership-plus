...
{
    /// <summary>
    /// Proxy for <see cref="IShortMessageTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ShortMessageTypeServiceProxy.AddOrUpdateEntities" />, <see cref="ShortMessageTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="ShortMessageTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ShortMessageTypeServiceProxy.NextPageBlock" /> and <see cref="ShortMessageTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ShortMessageTypeServiceProxy.QueryEntityCount" />, <see cref="ShortMessageTypeServiceProxy.QueryDatabase" />, <see cref="ShortMessageTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ShortMessageTypeServiceProxy.LoadEntityByKey" /> and <see cref="ShortMessageTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="ShortMessageTypeServiceProxy.GetNextSorterOps" /> and <see cref="ShortMessageTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ShortMessageTypeServiceProxy.MaterializeShortMessages" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="ShortMessageTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class ShortMessageTypeServiceProxy : ClientBase<IShortMessageTypeService2>, IShortMessageTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public ShortMessageTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public ShortMessageTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public ShortMessageTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "ShortMessageTypes". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="ShortMessageTypeSet" /> data model.
        /// </returns>
        public ShortMessageTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "ShortMessageTypes". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="ShortMessageTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<ShortMessageTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="ShortMessageType" />) is modified or its <see cref="ShortMessageType.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can also create and add to member collections in { <see cref="ShortMessageType.ChangedShortMessages" /> } entities that depends on an currently added or updated entity. These 
        ...
        /// </returns>
        public ChangeOpResults<ShortMessageTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<ShortMessageTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="ShortMessageType.ChangedShortMessages" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, ShortMessageTypeSet set, ShortMessageType[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="ShortMessageTypePageBlock" /> data model for entity set "ShortMessageTypes".
        /// </returns>
        public ShortMessageTypePageBlock NextPageBlock(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, ShortMessageType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="ShortMessageTypePageBlock" /> data model for entity set "ShortMessageTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<ShortMessageTypePageBlock> NextPageBlockAsync(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, ShortMessageType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="ShortMessageType" /> in set "ShortMessageTypes" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<ShortMessageType> GetPageItems(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, ShortMessageType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="ShortMessageType" /> in set "ShortMessageTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<ShortMessageType>> GetPageItemsAsync(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, ShortMessageType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "ShortMessageTypes" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "ShortMessageTypes" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageType" /> inside entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<ShortMessageType> QueryDatabase(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageType" /> inside entity set "ShortMessageTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<ShortMessageType>> QueryDatabaseAsync(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageType" /> inside entity set "ShortMessageTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<ShortMessageType> QueryDatabaseLimited(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="ShortMessageType" /> inside entity set "ShortMessageTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<ShortMessageType>> QueryDatabaseLimitedAsync(CallContext cntx, ShortMessageTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public ShortMessageSet MaterializeShortMessages(CallContext cntx, ShortMessageType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="ShortMessageSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<ShortMessageSet> MaterializeShortMessagesAsync(CallContext cntx, ShortMessageType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<ShortMessage> MaterializeAllShortMessages(CallContext cntx, ShortMessageType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{ShortMessage}" /> (T = <see cref="ShortMessage" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<ShortMessage>> MaterializeAllShortMessagesAsync(CallContext cntx, ShortMessageType entity)
        {
            try
            {
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="ShortMessageType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public ShortMessageType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="ShortMessageType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<ShortMessageType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="ShortMessageType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageType.ID" />.</param>
        ...
        /// </returns>
        public ShortMessageType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="ShortMessageType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="ShortMessageType.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<ShortMessageType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="ShortMessageType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="ShortMessageType.ID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<ShortMessageType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="ShortMessageType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="ShortMessageType.ID" />.</param>
        /// <remarks>
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<ShortMessageType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
