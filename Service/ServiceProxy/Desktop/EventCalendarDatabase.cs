...
{
    /// <summary>
    /// Proxy for <see cref="IEventCalendarService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.AddOrUpdateEntities" />, <see cref="EventCalendarServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="EventCalendarServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.NextPageBlock" /> and <see cref="EventCalendarServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.QueryEntityCount" />, <see cref="EventCalendarServiceProxy.QueryDatabase" />, <see cref="EventCalendarServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.LoadEntityByKey" /> and <see cref="EventCalendarServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.ConstraintQueryEntityCount" />, <see cref="EventCalendarServiceProxy.ConstraintQuery" />, <see cref="EventCalendarServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.GetNextSorterOps" /> and <see cref="EventCalendarServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.LoadEntityDescription" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="EventCalendarServiceProxy.UpdateEntityDescription" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventCalendarServiceProxy.MaterializeApplication_Ref" />, <see cref="EventCalendarServiceProxy.MaterializeEventTypeRef" />, <see cref="EventCalendarServiceProxy.MaterializeUserGroupRef" />, <see cref="EventCalendarServiceProxy.MaterializeUser_UserID" />, <see cref="EventCalendarServiceProxy.MaterializeUser_CreatedUserID" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventCalendarServiceProxy.MaterializeEventCalendarShareCircles" />, <see cref="EventCalendarServiceProxy.MaterializeNotificationTaskSchedules" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventCalendarServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class EventCalendarServiceProxy : ClientBase<IEventCalendarService2>, IEventCalendarService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public EventCalendarServiceProxy() 
            : base("HTTP")
        {
        ...
        public EventCalendarServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public EventCalendarServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public EventCalendarSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="EventCalendarSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendarSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<EventCalendarUpdateResult> AddOrUpdateEntities(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<EventCalendarUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="EventCalendar.ChangedEventCalendarShareCircles" />, <see cref="EventCalendar.ChangedNotificationTaskSchedules" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ///  add or updated to the data source following the same logic, all the object relationships will be properly setup if the operation is successful.
        ///  </para>
        ///  <para>
        ///  In general, a client can construct an object graph of any complexity following the above rules and have it added or updated to the data source in one step.
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, EventCalendarSet set, EventCalendar[] entities)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendarPageBlock NextPageBlock(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, EventCalendar prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="EventCalendarPageBlock" /> data model for entity set "EventCalendar".
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendarPageBlock> NextPageBlockAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, EventCalendar prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<EventCalendar> GetPageItems(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, EventCalendar prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="EventCalendar" /> in set "EventCalendar" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> GetPageItemsAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, EventCalendar prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<EventCalendar> QueryDatabase(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> QueryDatabaseAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventCalendar> QueryDatabaseLimited(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> QueryDatabaseLimitedAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventCalendar> ConstraintQuery(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> ConstraintQueryAsync(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventCalendar> ConstraintQueryLimited(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> ConstraintQueryLimitedAsync(CallContext cntx, EventCalendarSet set, EventCalendarSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        /// </returns>
        public EventType MaterializeEventTypeRef(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return Channel.MaterializeEventTypeRef(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="EventType" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<EventType> MaterializeEventTypeRefAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return await Channel.MaterializeEventTypeRefAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public UserGroup MaterializeUserGroupRef(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="UserGroup" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroup> MaterializeUserGroupRefAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        /// </returns>
        public User MaterializeUser_UserID(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return Channel.MaterializeUser_UserID(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_UserIDAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return await Channel.MaterializeUser_UserIDAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public User MaterializeUser_CreatedUserID(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return Channel.MaterializeUser_CreatedUserID(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_CreatedUserIDAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return await Channel.MaterializeUser_CreatedUserIDAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public EventCalendarSetConstraintsColl QuerySetConstraints(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="EventCalendarSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<EventCalendarSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, EventCalendarSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendarShareCircleSet MaterializeEventCalendarShareCircles(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return Channel.MaterializeEventCalendarShareCircles(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="EventCalendarShareCircleSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendarShareCircleSet> MaterializeEventCalendarShareCirclesAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return await Channel.MaterializeEventCalendarShareCirclesAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public IEnumerable<EventCalendarShareCircle> MaterializeAllEventCalendarShareCircles(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return Channel.MaterializeAllEventCalendarShareCircles(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An collecton of type <see cref="IEnumerable{EventCalendarShareCircle}" /> (T = <see cref="EventCalendarShareCircle" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendarShareCircle>> MaterializeAllEventCalendarShareCirclesAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
                return await Channel.MaterializeAllEventCalendarShareCirclesAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public NotificationTaskScheduleSet MaterializeNotificationTaskSchedules(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="NotificationTaskScheduleSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<NotificationTaskScheduleSet> MaterializeNotificationTaskSchedulesAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<NotificationTaskSchedule> MaterializeAllNotificationTaskSchedules(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{NotificationTaskSchedule}" /> (T = <see cref="NotificationTaskSchedule" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<NotificationTaskSchedule>> MaterializeAllNotificationTaskSchedulesAsync(CallContext cntx, EventCalendar entity)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendar LoadEntityByKey(CallContext cntx, string _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendar> LoadEntityByKeyAsync(CallContext cntx, string _ID)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendar LoadEntityGraphRecurs(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendar> LoadEntityGraphRecursAsync(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
