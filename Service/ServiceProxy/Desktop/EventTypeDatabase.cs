...
{
    /// <summary>
    /// Proxy for <see cref="IEventTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventTypeServiceProxy.AddOrUpdateEntities" />, <see cref="EventTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="EventTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventTypeServiceProxy.NextPageBlock" /> and <see cref="EventTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventTypeServiceProxy.QueryEntityCount" />, <see cref="EventTypeServiceProxy.QueryDatabase" />, <see cref="EventTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventTypeServiceProxy.LoadEntityByKey" /> and <see cref="EventTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="EventTypeServiceProxy.GetNextSorterOps" /> and <see cref="EventTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventTypeServiceProxy.MaterializeEventCalendars" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="EventTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class EventTypeServiceProxy : ClientBase<IEventTypeService2>, IEventTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public EventTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public EventTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public EventTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "EventTypes". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="EventTypeSet" /> data model.
        /// </returns>
        public EventTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "EventTypes". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="EventTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<EventTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="EventType" />) is modified or its <see cref="EventType.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can also create and add to member collections in { <see cref="EventType.ChangedEventCalendars" /> } entities that depends on an currently added or updated entity. These 
        ...
        /// </returns>
        public ChangeOpResults<EventTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<EventTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="EventType.ChangedEventCalendars" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, EventTypeSet set, EventType[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "EventTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="EventTypePageBlock" /> data model for entity set "EventTypes".
        /// </returns>
        public EventTypePageBlock NextPageBlock(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, EventType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "EventTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="EventTypePageBlock" /> data model for entity set "EventTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<EventTypePageBlock> NextPageBlockAsync(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, EventType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "EventTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="EventType" /> in set "EventTypes" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<EventType> GetPageItems(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, EventType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "EventTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="EventType" /> in set "EventTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventType>> GetPageItemsAsync(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, EventType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "EventTypes" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, EventTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "EventTypes" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, EventTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventType" /> inside entity set "EventTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<EventType> QueryDatabase(CallContext cntx, EventTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventType" /> inside entity set "EventTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventType>> QueryDatabaseAsync(CallContext cntx, EventTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventType" /> inside entity set "EventTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<EventType> QueryDatabaseLimited(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="EventType" /> inside entity set "EventTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventType>> QueryDatabaseLimitedAsync(CallContext cntx, EventTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendarSet MaterializeEventCalendars(CallContext cntx, EventType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="EventCalendarSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendarSet> MaterializeEventCalendarsAsync(CallContext cntx, EventType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<EventCalendar> MaterializeAllEventCalendars(CallContext cntx, EventType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{EventCalendar}" /> (T = <see cref="EventCalendar" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendar>> MaterializeAllEventCalendarsAsync(CallContext cntx, EventType entity)
        {
            try
            {
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="EventType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public EventType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="EventType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="EventType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventType.ID" />.</param>
        ...
        /// </returns>
        public EventType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="EventType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="EventType.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<EventType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="EventType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="EventType.ID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<EventType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="EventType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="EventType.ID" />.</param>
        /// <remarks>
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<EventType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
