...
{
    /// <summary>
    /// Proxy for <see cref="IUserGroupTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserGroupTypeServiceProxy.AddOrUpdateEntities" />, <see cref="UserGroupTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserGroupTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserGroupTypeServiceProxy.NextPageBlock" /> and <see cref="UserGroupTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserGroupTypeServiceProxy.QueryEntityCount" />, <see cref="UserGroupTypeServiceProxy.QueryDatabase" />, <see cref="UserGroupTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserGroupTypeServiceProxy.LoadEntityByKey" /> and <see cref="UserGroupTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserGroupTypeServiceProxy.GetNextSorterOps" /> and <see cref="UserGroupTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserGroupTypeServiceProxy.MaterializeUserGroups" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserGroupTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserGroupTypeServiceProxy : ClientBase<IUserGroupTypeService2>, IUserGroupTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UserGroupTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public UserGroupTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserGroupTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public UserGroupTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="UserGroupTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroupTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<UserGroupTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserGroupTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserGroupType.ChangedUserGroups" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserGroupTypeSet set, UserGroupType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public UserGroupTypePageBlock NextPageBlock(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, UserGroupType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="UserGroupTypePageBlock" /> data model for entity set "UserGroupTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroupTypePageBlock> NextPageBlockAsync(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, UserGroupType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<UserGroupType> GetPageItems(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, UserGroupType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="UserGroupType" /> in set "UserGroupTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserGroupType>> GetPageItemsAsync(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, UserGroupType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<UserGroupType> QueryDatabase(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserGroupType>> QueryDatabaseAsync(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserGroupType> QueryDatabaseLimited(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserGroupType>> QueryDatabaseLimitedAsync(CallContext cntx, UserGroupTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public UserGroupSet MaterializeUserGroups(CallContext cntx, UserGroupType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="UserGroupSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroupSet> MaterializeUserGroupsAsync(CallContext cntx, UserGroupType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<UserGroup> MaterializeAllUserGroups(CallContext cntx, UserGroupType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{UserGroup}" /> (T = <see cref="UserGroup" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserGroup>> MaterializeAllUserGroupsAsync(CallContext cntx, UserGroupType entity)
        {
            try
            {
        ...
        /// </returns>
        public UserGroupType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroupType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// </returns>
        public UserGroupType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserGroupType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<UserGroupType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserGroupType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
