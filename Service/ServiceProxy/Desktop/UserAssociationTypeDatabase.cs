...
{
    /// <summary>
    /// Proxy for <see cref="IUserAssociationTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationTypeServiceProxy.AddOrUpdateEntities" />, <see cref="UserAssociationTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserAssociationTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationTypeServiceProxy.NextPageBlock" /> and <see cref="UserAssociationTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationTypeServiceProxy.QueryEntityCount" />, <see cref="UserAssociationTypeServiceProxy.QueryDatabase" />, <see cref="UserAssociationTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationTypeServiceProxy.LoadEntityByKey" /> and <see cref="UserAssociationTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserAssociationTypeServiceProxy.GetNextSorterOps" /> and <see cref="UserAssociationTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserAssociationTypeServiceProxy.MaterializeEventCalendarShareCircles" />, <see cref="UserAssociationTypeServiceProxy.MaterializeUserAssociations" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserAssociationTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserAssociationTypeServiceProxy : ClientBase<IUserAssociationTypeService2>, IUserAssociationTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UserAssociationTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public UserAssociationTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserAssociationTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "UserAssociationTypes". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="UserAssociationTypeSet" /> data model.
        /// </returns>
        public UserAssociationTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "UserAssociationTypes". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="UserAssociationTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="UserAssociationType" />) is modified or its <see cref="UserAssociationType.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can also create and add to member collections in { <see cref="UserAssociationType.ChangedEventCalendarShareCircles" />, <see cref="UserAssociationType.ChangedUserAssociations" /> } entities that depends on an currently added or updated entity. These 
        ...
        /// </returns>
        public ChangeOpResults<UserAssociationTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserAssociationTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserAssociationType.ChangedEventCalendarShareCircles" />, <see cref="UserAssociationType.ChangedUserAssociations" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserAssociationTypeSet set, UserAssociationType[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="UserAssociationTypePageBlock" /> data model for entity set "UserAssociationTypes".
        /// </returns>
        public UserAssociationTypePageBlock NextPageBlock(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, UserAssociationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="UserAssociationTypePageBlock" /> data model for entity set "UserAssociationTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationTypePageBlock> NextPageBlockAsync(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, UserAssociationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="UserAssociationType" /> in set "UserAssociationTypes" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<UserAssociationType> GetPageItems(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, UserAssociationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="UserAssociationType" /> in set "UserAssociationTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociationType>> GetPageItemsAsync(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, UserAssociationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "UserAssociationTypes" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "UserAssociationTypes" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociationType" /> inside entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<UserAssociationType> QueryDatabase(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociationType" /> inside entity set "UserAssociationTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociationType>> QueryDatabaseAsync(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociationType" /> inside entity set "UserAssociationTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserAssociationType> QueryDatabaseLimited(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserAssociationType" /> inside entity set "UserAssociationTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociationType>> QueryDatabaseLimitedAsync(CallContext cntx, UserAssociationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public EventCalendarShareCircleSet MaterializeEventCalendarShareCircles(CallContext cntx, UserAssociationType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="EventCalendarShareCircleSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<EventCalendarShareCircleSet> MaterializeEventCalendarShareCirclesAsync(CallContext cntx, UserAssociationType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<EventCalendarShareCircle> MaterializeAllEventCalendarShareCircles(CallContext cntx, UserAssociationType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{EventCalendarShareCircle}" /> (T = <see cref="EventCalendarShareCircle" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<EventCalendarShareCircle>> MaterializeAllEventCalendarShareCirclesAsync(CallContext cntx, UserAssociationType entity)
        {
            try
            {
        ...
        /// <summary>
        ///   Load the set of depending entities "UserAssociations" of type <see cref="UserAssociationSet" /> of the entity. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <remarks>
        ...
        /// </returns>
        public UserAssociationSet MaterializeUserAssociations(CallContext cntx, UserAssociationType entity)
        {
            try
            {
                return Channel.MaterializeUserAssociations(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load the set of depending entities "UserAssociations" of type <see cref="UserAssociationSet" /> of the entity. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <remarks>
        ...
        ///   An entity of type <see cref="UserAssociationSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationSet> MaterializeUserAssociationsAsync(CallContext cntx, UserAssociationType entity)
        {
            try
            {
                return await Channel.MaterializeUserAssociationsAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// <summary>
        ///   Load the collection of depending entities "AllUserAssociations" of type <see cref="IEnumerable{UserAssociation}" /> (T = <see cref="UserAssociation" />) of the entity. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <returns>
        ...
        /// </returns>
        public IEnumerable<UserAssociation> MaterializeAllUserAssociations(CallContext cntx, UserAssociationType entity)
        {
            try
            {
                return Channel.MaterializeAllUserAssociations(cntx, entity.ShallowCopy()).Select(d => { d.StartAutoUpdating = true; return d; });
            }
            catch (Exception ex)
            {
                HandleError(ex);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load the collection of depending entities "AllUserAssociations" of type <see cref="IEnumerable{UserAssociation}" /> (T = <see cref="UserAssociation" />) of the entity. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <returns>
        ///   An collecton of type <see cref="IEnumerable{UserAssociation}" /> (T = <see cref="UserAssociation" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAssociation>> MaterializeAllUserAssociationsAsync(CallContext cntx, UserAssociationType entity)
        {
            try
            {
                return (await Channel.MaterializeAllUserAssociationsAsync(cntx, entity.ShallowCopy())).Select(d => { d.StartAutoUpdating = true; return d; });
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserAssociationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserAssociationType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public UserAssociationType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserAssociationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserAssociationType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserAssociationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserAssociationType.ID" />.</param>
        ...
        /// </returns>
        public UserAssociationType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserAssociationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserAssociationType.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAssociationType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserAssociationType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="UserAssociationType.ID" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<UserAssociationType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserAssociationType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Intrinsic id <see cref="UserAssociationType.ID" />.</param>
        /// <remarks>
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserAssociationType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
