...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="Application_ServiceProxy.MaterializeAnnouncements" />, <see cref="Application_ServiceProxy.MaterializeCommunications" />, <see cref="Application_ServiceProxy.MaterializeEventCalendars" />, <see cref="Application_ServiceProxy.MaterializeMemberNotifications" />, <see cref="Application_ServiceProxy.MaterializeRoles" />, <see cref="Application_ServiceProxy.MaterializeSignalRMessages" />, <see cref="Application_ServiceProxy.MaterializeUserAppMembers" />, <see cref="Application_ServiceProxy.MaterializeUserDetails" />, <see cref="Application_ServiceProxy.MaterializeUserGroups" />, <see cref="Application_ServiceProxy.MaterializeUserProfiles" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    public class Application_ServiceProxy : ClientBase<IApplication_Service2>, IApplication_Service2
    {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="Application_.ChangedAnnouncements" />, <see cref="Application_.ChangedCommunications" />, <see cref="Application_.ChangedEventCalendars" />, <see cref="Application_.ChangedMemberNotifications" />, <see cref="Application_.ChangedRoles" />, <see cref="Application_.ChangedSignalRMessages" />, <see cref="Application_.ChangedUserAppMembers" />, <see cref="Application_.ChangedUserDetails" />, <see cref="Application_.ChangedUserGroups" />, <see cref="Application_.ChangedUserProfiles" /> } that an currently added or updated entity depends upon. These additional entities will be 
