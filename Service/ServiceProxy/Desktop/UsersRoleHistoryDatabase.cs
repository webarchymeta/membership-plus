...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UsersRoleHistoryServiceProxy : ClientBase<IUsersRoleHistoryService2>, IUsersRoleHistoryService2
    {
        ...
        public User MaterializeUser_OperatorID(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
                return Channel.MaterializeUser_OperatorID(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public async System.Threading.Tasks.Task<User> MaterializeUser_OperatorIDAsync(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
                return await Channel.MaterializeUser_OperatorIDAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public List<UsersRoleHistory> LoadEntityByNature(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
        ...
        ///   The list of found entities.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UsersRoleHistory>> LoadEntityByNatureAsync(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
