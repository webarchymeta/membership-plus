...
{
    /// <summary>
    /// Proxy for <see cref="IUsersRoleHistoryService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.AddOrUpdateEntities" />, <see cref="UsersRoleHistoryServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UsersRoleHistoryServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.NextPageBlock" /> and <see cref="UsersRoleHistoryServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.QueryEntityCount" />, <see cref="UsersRoleHistoryServiceProxy.QueryDatabase" />, <see cref="UsersRoleHistoryServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.LoadEntityByKey" /> and <see cref="UsersRoleHistoryServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.ConstraintQueryEntityCount" />, <see cref="UsersRoleHistoryServiceProxy.ConstraintQuery" />, <see cref="UsersRoleHistoryServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UsersRoleHistoryServiceProxy.GetNextSorterOps" /> and <see cref="UsersRoleHistoryServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UsersRoleHistoryServiceProxy.MaterializeRoleRef" />, <see cref="UsersRoleHistoryServiceProxy.MaterializeUser_UserID" />, <see cref="UsersRoleHistoryServiceProxy.MaterializeUser_OperatorID" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UsersRoleHistoryServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UsersRoleHistoryServiceProxy : ClientBase<IUsersRoleHistoryService2>, IUsersRoleHistoryService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UsersRoleHistoryServiceProxy() 
            : base("HTTP")
        {
        ...
        public UsersRoleHistoryServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UsersRoleHistoryServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "UsersRoleHistories". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="UsersRoleHistorySet" /> data model.
        /// </returns>
        public UsersRoleHistorySet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "UsersRoleHistories". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="UsersRoleHistorySet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UsersRoleHistorySet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="UsersRoleHistory" />) is modified or its <see cref="UsersRoleHistory.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UsersRoleHistory.RoleRef" />, <see cref="UsersRoleHistory.User_UserID" />, <see cref="UsersRoleHistory.User_OperatorID" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// </returns>
        public ChangeOpResults<UsersRoleHistoryUpdateResult> AddOrUpdateEntities(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UsersRoleHistoryUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistory[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="UsersRoleHistoryPageBlock" /> data model for entity set "UsersRoleHistories".
        /// </returns>
        public UsersRoleHistoryPageBlock NextPageBlock(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, UsersRoleHistory prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="UsersRoleHistoryPageBlock" /> data model for entity set "UsersRoleHistories".
        /// </returns>
        public async System.Threading.Tasks.Task<UsersRoleHistoryPageBlock> NextPageBlockAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, UsersRoleHistory prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="UsersRoleHistory" /> in set "UsersRoleHistories" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<UsersRoleHistory> GetPageItems(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, UsersRoleHistory prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="UsersRoleHistory" /> in set "UsersRoleHistories" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UsersRoleHistory>> GetPageItemsAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, UsersRoleHistory prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "UsersRoleHistories" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "UsersRoleHistories" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<UsersRoleHistory> QueryDatabase(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UsersRoleHistory>> QueryDatabaseAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UsersRoleHistory> QueryDatabaseLimited(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UsersRoleHistory>> QueryDatabaseLimitedAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="cnstSets">A collection of sets of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        /// <returns>
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UsersRoleHistory> ConstraintQuery(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" from the data source restricted by a set of specified foreign key values and under specified filtering, sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UsersRoleHistory>> ConstraintQueryAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UsersRoleHistory> ConstraintQueryLimited(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source restricted by a set of specified foreign key values and under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="constraints">A set of foreign key wrapper pointing to primary keys of the sets that "UsersRoleHistories" depends upon. If a user do not wish to set a contraint for it, then set it to null, </param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UsersRoleHistory>> ConstraintQueryLimitedAsync(CallContext cntx, UsersRoleHistorySet set, UsersRoleHistorySetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Role MaterializeRoleRef(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Role" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Role> MaterializeRoleRefAsync(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
        ...
        /// </returns>
        public User MaterializeUser_UserID(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_UserIDAsync(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
        ...
        /// <summary>
        ///   Load the entity "User_OperatorID" of type <see cref="User" /> that the entity depend upon. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <remarks>
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public User MaterializeUser_OperatorID(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
                var e = Channel.MaterializeUser_OperatorID(cntx, entity.ShallowCopy()); 
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Load the entity "User_OperatorID" of type <see cref="User" /> that the entity depend upon. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="entity">The entity.</param>
        /// <remarks>
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUser_OperatorIDAsync(CallContext cntx, UsersRoleHistory entity)
        {
            try
            {
                var e = await Channel.MaterializeUser_OperatorIDAsync(cntx, entity.ShallowCopy());
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UsersRoleHistorySet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public UsersRoleHistorySetConstraintsColl QuerySetConstraints(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of non-trivial foreign key constrains of type <see cref="UsersRoleHistory" /> inside entity set "UsersRoleHistories" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Filter expression for the set.</param>
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UsersRoleHistorySet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<UsersRoleHistorySetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UsersRoleHistorySet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UsersRoleHistory.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UsersRoleHistory.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public UsersRoleHistory LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UsersRoleHistory.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UsersRoleHistory.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UsersRoleHistory> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UsersRoleHistory.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UsersRoleHistory.ID" />.</param>
        ...
        /// </returns>
        public UsersRoleHistory LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UsersRoleHistory.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UsersRoleHistory.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UsersRoleHistory> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<UsersRoleHistory> LoadEntityByNature(CallContext cntx, DateTime _ChangeDate, int _RoleID, string _UserID)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _ChangeDate, _RoleID, _UserID);
        ...
        ///   The list of found entities.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UsersRoleHistory>> LoadEntityByNatureAsync(CallContext cntx, DateTime _ChangeDate, int _RoleID, string _UserID)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _ChangeDate, _RoleID, _UserID);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
