...
{
    /// <summary>
    /// Proxy for <see cref="IUserProfileTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileTypeServiceProxy.AddOrUpdateEntities" />, <see cref="UserProfileTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserProfileTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileTypeServiceProxy.NextPageBlock" /> and <see cref="UserProfileTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileTypeServiceProxy.QueryEntityCount" />, <see cref="UserProfileTypeServiceProxy.QueryDatabase" />, <see cref="UserProfileTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileTypeServiceProxy.LoadEntityByKey" /> and <see cref="UserProfileTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileTypeServiceProxy.GetNextSorterOps" /> and <see cref="UserProfileTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserProfileTypeServiceProxy.MaterializeUserProfiles" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserProfileTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserProfileTypeServiceProxy : ClientBase<IUserProfileTypeService2>, IUserProfileTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UserProfileTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public UserProfileTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserProfileTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// <summary>
        ///   Retrieve information about the entity set: "UserProfileTypes". 
        /// </summary>
        ...
        /// <returns>
        ///   Entity set: <see cref="UserProfileTypeSet" /> data model.
        /// </returns>
        public UserProfileTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Retrieve information about the entity set: "UserProfileTypes". Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="filter">Filter expression for the current set.</param>
        /// <returns>
        ///   Entity set: <see cref="UserProfileTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///  <see cref="UserProfileType" />) is modified or its <see cref="UserProfileType.IsEntityChanged" /> property is
        ///  not set to <c>true</c>. 
        ///  </para>
        ///  <para>
        ///  Clients can also create and add to member collections in { <see cref="UserProfileType.ChangedUserProfiles" /> } entities that depends on an currently added or updated entity. These 
        ...
        /// </returns>
        public ChangeOpResults<UserProfileTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserProfileTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserProfileType.ChangedUserProfiles" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserProfileTypeSet set, UserProfileType[] entities)
        {
            try
            {
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   <see cref="UserProfileTypePageBlock" /> data model for entity set "UserProfileTypes".
        /// </returns>
        public UserProfileTypePageBlock NextPageBlock(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, UserProfileType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Get a block of page frames from the entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size and the page block size is specified inside "set".
        /// </remarks>
        ...
        ///   <see cref="UserProfileTypePageBlock" /> data model for entity set "UserProfileTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileTypePageBlock> NextPageBlockAsync(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, UserProfileType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <remarks>
        ...
        /// <returns>
        ///   Collection of <see cref="UserProfileType" /> in set "UserProfileTypes" for the current page defined by "prevlast".
        /// </returns>
        public IEnumerable<UserProfileType> GetPageItems(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, UserProfileType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Load entities of a page from the entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <remarks>
        /// The page size is specified inside "set".
        /// </remarks>
        ...
        ///   Collection of <see cref="UserProfileType" /> in set "UserProfileTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfileType>> GetPageItemsAsync(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, UserProfileType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// <summary>
        ///   Count the number of entities inside entity set "UserProfileTypes" of the data source under specified filtering condition. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Count the number of entities inside entity set "UserProfileTypes" of the data source under specified filtering condition. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserProfileType" /> inside entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        /// </returns>
        public IEnumerable<UserProfileType> QueryDatabase(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserProfileType" /> inside entity set "UserProfileTypes" of the data source under specified filtering and sorting conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfileType>> QueryDatabaseAsync(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserProfileType" /> inside entity set "UserProfileTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserProfileType> QueryDatabaseLimited(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///   Get the collection of entities of type <see cref="UserProfileType" /> inside entity set "UserProfileTypes" from the data source under specified filtering, sorting and max number of returning entities conditions. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="set">Set information.</param>
        /// <param name="qexpr">Tokenized querying and sorting expression.</param>
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfileType>> QueryDatabaseLimitedAsync(CallContext cntx, UserProfileTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public UserProfileSet MaterializeUserProfiles(CallContext cntx, UserProfileType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="UserProfileSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileSet> MaterializeUserProfilesAsync(CallContext cntx, UserProfileType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<UserProfile> MaterializeAllUserProfiles(CallContext cntx, UserProfileType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{UserProfile}" /> (T = <see cref="UserProfile" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> MaterializeAllUserProfilesAsync(CallContext cntx, UserProfileType entity)
        {
            try
            {
        ...
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserProfileType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserProfileType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public UserProfileType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load an entity from the entity set having specified primary key(s): { <see cref="UserProfileType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserProfileType.ID" />.</param>
        /// <returns>
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserProfileType.ID" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserProfileType.ID" />.</param>
        ...
        /// </returns>
        public UserProfileType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a selected entity graph from the data source starting at an entity having specified primary key(s): { <see cref="UserProfileType.ID" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ID">Primary key <see cref="UserProfileType.ID" />.</param>
        /// <param name="excludedSets">A list of sets to be excluded. </param>
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserProfileType.ClrType" />, <see cref="UserProfileType.SerializationProvider" />, <see cref="UserProfileType.SerializeType" /> }. 
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ClrType">Intrinsic id <see cref="UserProfileType.ClrType" />.</param>
        /// <param name="_SerializationProvider">Intrinsic id <see cref="UserProfileType.SerializationProvider" />.</param>
        /// <param name="_SerializeType">Intrinsic id <see cref="UserProfileType.SerializeType" />.</param>
        /// <remarks>
        ///  <para>
        ...
        /// </returns>
        public List<UserProfileType> LoadEntityByNature(CallContext cntx, string _ClrType, string _SerializationProvider, string _SerializeType)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _ClrType, _SerializationProvider, _SerializeType);
...
#if SUPPORT_ASYNC
        /// <summary>
        ///  Load a set entities from the entity set having specified intrinsic ids: { <see cref="UserProfileType.ClrType" />, <see cref="UserProfileType.SerializationProvider" />, <see cref="UserProfileType.SerializeType" /> }. Awaitable asynchronous version.
        /// </summary>
        /// <param name="cntx">Authenticated caller context object. If cannot be null.</param>
        /// <param name="_ClrType">Intrinsic id <see cref="UserProfileType.ClrType" />.</param>
        /// <param name="_SerializationProvider">Intrinsic id <see cref="UserProfileType.SerializationProvider" />.</param>
        ...
        ///   The list of found entities.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserProfileType>> LoadEntityByNatureAsync(CallContext cntx, string _ClrType, string _SerializationProvider, string _SerializeType)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _ClrType, _SerializationProvider, _SerializeType);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
