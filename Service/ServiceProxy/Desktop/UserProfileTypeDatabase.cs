...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UserProfileTypeServiceProxy : ClientBase<IUserProfileTypeService2>, IUserProfileTypeService2
    {
        ...
        public List<UserProfileType> LoadEntityByNature(CallContext cntx, string _ClrType, string _SerializationProvider, string _SerializeType)
        {
            try
            {
                return Channel.LoadEntityByNature(cntx, _ClrType, _SerializationProvider, _SerializeType);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public async System.Threading.Tasks.Task<List<UserProfileType>> LoadEntityByNatureAsync(CallContext cntx, string _ClrType, string _SerializationProvider, string _SerializeType)
        {
            try
            {
                return await Channel.LoadEntityByNatureAsync(cntx, _ClrType, _SerializationProvider, _SerializeType);
            }
            catch (Exception ex)
            {
                HandleError(ex);
