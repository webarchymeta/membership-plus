...
{
    /// <summary>
    /// Proxy for <see cref="IMemberNotificationTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="MemberNotificationTypeServiceProxy.AddOrUpdateEntities" />, <see cref="MemberNotificationTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="MemberNotificationTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="MemberNotificationTypeServiceProxy.NextPageBlock" /> and <see cref="MemberNotificationTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="MemberNotificationTypeServiceProxy.QueryEntityCount" />, <see cref="MemberNotificationTypeServiceProxy.QueryDatabase" />, <see cref="MemberNotificationTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="MemberNotificationTypeServiceProxy.LoadEntityByKey" /> and <see cref="MemberNotificationTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="MemberNotificationTypeServiceProxy.GetNextSorterOps" /> and <see cref="MemberNotificationTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="MemberNotificationTypeServiceProxy.MaterializeMemberNotifications" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="MemberNotificationTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class MemberNotificationTypeServiceProxy : ClientBase<IMemberNotificationTypeService2>, IMemberNotificationTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public MemberNotificationTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public MemberNotificationTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public MemberNotificationTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public MemberNotificationTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="MemberNotificationTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<MemberNotificationTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<MemberNotificationTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<MemberNotificationTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="MemberNotificationType.ChangedMemberNotifications" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, MemberNotificationTypeSet set, MemberNotificationType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public MemberNotificationTypePageBlock NextPageBlock(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="MemberNotificationTypePageBlock" /> data model for entity set "MemberNotificationTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<MemberNotificationTypePageBlock> NextPageBlockAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<MemberNotificationType> GetPageItems(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="MemberNotificationType" /> in set "MemberNotificationTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> GetPageItemsAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, MemberNotificationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<MemberNotificationType> QueryDatabase(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> QueryDatabaseAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<MemberNotificationType> QueryDatabaseLimited(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<MemberNotificationType>> QueryDatabaseLimitedAsync(CallContext cntx, MemberNotificationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public MemberNotificationSet MaterializeMemberNotifications(CallContext cntx, MemberNotificationType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="MemberNotificationSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<MemberNotificationSet> MaterializeMemberNotificationsAsync(CallContext cntx, MemberNotificationType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<MemberNotification> MaterializeAllMemberNotifications(CallContext cntx, MemberNotificationType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{MemberNotification}" /> (T = <see cref="MemberNotification" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<MemberNotification>> MaterializeAllMemberNotificationsAsync(CallContext cntx, MemberNotificationType entity)
        {
            try
            {
        ...
        /// </returns>
        public MemberNotificationType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<MemberNotificationType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// </returns>
        public MemberNotificationType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<MemberNotificationType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<MemberNotificationType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<MemberNotificationType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
