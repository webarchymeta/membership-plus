...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    ///      <description>
    ///         <see cref="UserAppMemberServiceProxy.LoadEntityComment" />, <see cref="UserAppMemberServiceProxy.LoadEntityIconImg" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="UserAppMemberServiceProxy.UpdateEntityComment" />, <see cref="UserAppMemberServiceProxy.UpdateEntityIconImg" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserAppMemberServiceProxy.MaterializeMemberCallbacks" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    public class UserAppMemberServiceProxy : ClientBase<IUserAppMemberService2>, IUserAppMemberService2
    {
        ...
        ///   Entity set: <see cref="UserAppMemberSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAppMemberSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserAppMemberUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserAppMemberSet set, UserAppMember[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="UserAppMember.ChangedMemberCallbacks" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ///  add or updated to the data source following the same logic, all the object relationships will be properly setup if the operation is successful.
        ///  </para>
        ///  <para>
        ///  In general, a client can construct an object graph of any complexity following the above rules and have it added or updated to the data source in one step.
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserAppMemberSet set, UserAppMember[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserAppMemberSet set, UserAppMember[] entities)
        {
            try
            {
        ...
        ///   <see cref="UserAppMemberPageBlock" /> data model for entity set "UserAppMembers".
        /// </returns>
        public async System.Threading.Tasks.Task<UserAppMemberPageBlock> NextPageBlockAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr, UserAppMember prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="UserAppMember" /> in set "UserAppMembers" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAppMember>> GetPageItemsAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr, UserAppMember prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAppMember>> QueryDatabaseAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAppMember>> QueryDatabaseLimitedAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserAppMemberSet set, UserAppMemberSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserAppMemberSet set, UserAppMemberSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAppMember>> ConstraintQueryAsync(CallContext cntx, UserAppMemberSet set, UserAppMemberSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserAppMember>> ConstraintQueryLimitedAsync(CallContext cntx, UserAppMemberSet set, UserAppMemberSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, UserAppMember entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, UserAppMember entity)
        {
            try
            {
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserAppMemberSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<UserAppMemberSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserAppMemberSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        public MemberCallbackSet MaterializeMemberCallbacks(CallContext cntx, UserAppMember entity)
        {
            try
            {
                return Channel.MaterializeMemberCallbacks(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="MemberCallbackSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<MemberCallbackSet> MaterializeMemberCallbacksAsync(CallContext cntx, UserAppMember entity)
        {
            try
            {
                return await Channel.MaterializeMemberCallbacksAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public IEnumerable<MemberCallback> MaterializeAllMemberCallbacks(CallContext cntx, UserAppMember entity)
        {
            try
            {
                return Channel.MaterializeAllMemberCallbacks(cntx, entity.ShallowCopy()).Select(d => { d.StartAutoUpdating = true; return d; });
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An collecton of type <see cref="IEnumerable{MemberCallback}" /> (T = <see cref="MemberCallback" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<MemberCallback>> MaterializeAllMemberCallbacksAsync(CallContext cntx, UserAppMember entity)
        {
            try
            {
                return (await Channel.MaterializeAllMemberCallbacksAsync(cntx, entity.ShallowCopy())).Select(d => { d.StartAutoUpdating = true; return d; });
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public UserAppMember LoadEntityByKey(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
                var e = Channel.LoadEntityByKey(cntx, _ApplicationID, _UserID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAppMember> LoadEntityByKeyAsync(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
                var e = await Channel.LoadEntityByKeyAsync(cntx, _ApplicationID, _UserID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserAppMember> LoadEntityGraphRecursAsync(CallContext cntx, string _ApplicationID, string _UserID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserAppMember>> LoadEntityByNatureAsync(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<string> LoadEntityCommentAsync(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
                return await Channel.LoadEntityCommentAsync(cntx, _ApplicationID, _UserID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task UpdateEntityCommentAsync(CallContext cntx, string _ApplicationID, string _UserID, string data)
        {
            try
            {
                await Channel.UpdateEntityCommentAsync(cntx, _ApplicationID, _UserID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public byte[] LoadEntityIconImg(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
                return Channel.LoadEntityIconImg(cntx, _ApplicationID, _UserID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<byte[]> LoadEntityIconImgAsync(CallContext cntx, string _ApplicationID, string _UserID)
        {
            try
            {
                return await Channel.LoadEntityIconImgAsync(cntx, _ApplicationID, _UserID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public void UpdateEntityIconImg(CallContext cntx, string _ApplicationID, string _UserID, System.Nullable<DateTime> _IconLastModified, string _IconMime, byte[] data)
        {
            try
            {
                Channel.UpdateEntityIconImg(cntx, _ApplicationID, _UserID, _IconLastModified, _IconMime, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task UpdateEntityIconImgAsync(CallContext cntx, string _ApplicationID, string _UserID, System.Nullable<DateTime> _IconLastModified, string _IconMime, byte[] data)
        {
            try
            {
                await Channel.UpdateEntityIconImgAsync(cntx, _ApplicationID, _UserID, _IconLastModified, _IconMime, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
