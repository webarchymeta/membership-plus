...
{
    /// <summary>
    /// Proxy for <see cref="ICommunicationTypeService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationTypeServiceProxy.AddOrUpdateEntities" />, <see cref="CommunicationTypeServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="CommunicationTypeServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationTypeServiceProxy.NextPageBlock" /> and <see cref="CommunicationTypeServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationTypeServiceProxy.QueryEntityCount" />, <see cref="CommunicationTypeServiceProxy.QueryDatabase" />, <see cref="CommunicationTypeServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationTypeServiceProxy.LoadEntityByKey" /> and <see cref="CommunicationTypeServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationTypeServiceProxy.GetNextSorterOps" /> and <see cref="CommunicationTypeServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="CommunicationTypeServiceProxy.MaterializeCommunications" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="CommunicationTypeServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class CommunicationTypeServiceProxy : ClientBase<ICommunicationTypeService2>, ICommunicationTypeService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public CommunicationTypeServiceProxy() 
            : base("HTTP")
        {
        ...
        public CommunicationTypeServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public CommunicationTypeServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public CommunicationTypeSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="CommunicationTypeSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationTypeSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<CommunicationTypeUpdateResult> AddOrUpdateEntities(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<CommunicationTypeUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        ///  </para>
        ///  <para>
        ///  Clients can set some of the member entities in { <see cref="CommunicationType.ChangedCommunications" /> } that an currently added or updated entity depends upon. These additional entities will be 
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, CommunicationTypeSet set, CommunicationType[] entities)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationTypePageBlock NextPageBlock(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, CommunicationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="CommunicationTypePageBlock" /> data model for entity set "CommunicationTypes".
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationTypePageBlock> NextPageBlockAsync(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, CommunicationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<CommunicationType> GetPageItems(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, CommunicationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="CommunicationType" /> in set "CommunicationTypes" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<CommunicationType>> GetPageItemsAsync(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, CommunicationType prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<CommunicationType> QueryDatabase(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<CommunicationType>> QueryDatabaseAsync(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<CommunicationType> QueryDatabaseLimited(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<CommunicationType>> QueryDatabaseLimitedAsync(CallContext cntx, CommunicationTypeSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationSet MaterializeCommunications(CallContext cntx, CommunicationType entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="CommunicationSet" />.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationSet> MaterializeCommunicationsAsync(CallContext cntx, CommunicationType entity)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<Communication> MaterializeAllCommunications(CallContext cntx, CommunicationType entity)
        {
            try
            {
        ...
        ///   An collecton of type <see cref="IEnumerable{Communication}" /> (T = <see cref="Communication" />).
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> MaterializeAllCommunicationsAsync(CallContext cntx, CommunicationType entity)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationType LoadEntityByKey(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationType> LoadEntityByKeyAsync(CallContext cntx, int _ID)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationType LoadEntityGraphRecurs(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationType> LoadEntityGraphRecursAsync(CallContext cntx, int _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<CommunicationType> LoadEntityByNature(CallContext cntx, int _ID)
        {
            try
            {
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<CommunicationType>> LoadEntityByNatureAsync(CallContext cntx, int _ID)
        {
            try
            {
