...
{
    /// <summary>
    /// Proxy for <see cref="ICommunicationService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.AddOrUpdateEntities" />, <see cref="CommunicationServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="CommunicationServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.NextPageBlock" /> and <see cref="CommunicationServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.QueryEntityCount" />, <see cref="CommunicationServiceProxy.QueryDatabase" />, <see cref="CommunicationServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.LoadEntityByKey" /> and <see cref="CommunicationServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.ConstraintQueryEntityCount" />, <see cref="CommunicationServiceProxy.ConstraintQuery" />, <see cref="CommunicationServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.GetNextSorterOps" /> and <see cref="CommunicationServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.LoadEntityComment" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="CommunicationServiceProxy.UpdateEntityComment" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="CommunicationServiceProxy.MaterializeApplication_Ref" />, <see cref="CommunicationServiceProxy.MaterializeCommunicationTypeRef" />, <see cref="CommunicationServiceProxy.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="CommunicationServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class CommunicationServiceProxy : ClientBase<ICommunicationService2>, ICommunicationService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public CommunicationServiceProxy() 
            : base("HTTP")
        {
        ...
        public CommunicationServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public CommunicationServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public CommunicationSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="CommunicationSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<CommunicationUpdateResult> AddOrUpdateEntities(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<CommunicationUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, CommunicationSet set, Communication[] entities)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationPageBlock NextPageBlock(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, Communication prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="CommunicationPageBlock" /> data model for entity set "Communications".
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationPageBlock> NextPageBlockAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, Communication prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<Communication> GetPageItems(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, Communication prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="Communication" /> in set "Communications" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> GetPageItemsAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, Communication prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, CommunicationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<Communication> QueryDatabase(CallContext cntx, CommunicationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> QueryDatabaseAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<Communication> QueryDatabaseLimited(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> QueryDatabaseLimitedAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, CommunicationSet set, CommunicationSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, CommunicationSet set, CommunicationSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<Communication> ConstraintQuery(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> ConstraintQueryAsync(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<Communication> ConstraintQueryLimited(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<Communication>> ConstraintQueryLimitedAsync(CallContext cntx, CommunicationSet set, CommunicationSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, Communication entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, Communication entity)
        {
            try
            {
        ...
        /// </returns>
        public CommunicationType MaterializeCommunicationTypeRef(CallContext cntx, Communication entity)
        {
            try
            {
                return Channel.MaterializeCommunicationTypeRef(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   An entity of type <see cref="CommunicationType" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<CommunicationType> MaterializeCommunicationTypeRefAsync(CallContext cntx, Communication entity)
        {
            try
            {
                return await Channel.MaterializeCommunicationTypeRefAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        /// </returns>
        public User MaterializeUserRef(CallContext cntx, Communication entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, Communication entity)
        {
            try
            {
        ...
        public CommunicationSetConstraintsColl QuerySetConstraints(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="CommunicationSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<CommunicationSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, CommunicationSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        public Communication LoadEntityByKey(CallContext cntx, string _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<Communication> LoadEntityByKeyAsync(CallContext cntx, string _ID)
        {
            try
            {
        ...
        /// </returns>
        public Communication LoadEntityGraphRecurs(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<Communication> LoadEntityGraphRecursAsync(CallContext cntx, string _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<Communication> LoadEntityByNature(CallContext cntx, string _ID)
        {
            try
            {
        ...
        ///   Null or zero or one entity.
        /// </returns>
        public async System.Threading.Tasks.Task<List<Communication>> LoadEntityByNatureAsync(CallContext cntx, string _ID)
        {
            try
            {
        ...
        /// </returns>
        public string LoadEntityComment(CallContext cntx, string _ID)
        {
            try
            {
                return Channel.LoadEntityComment(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<string> LoadEntityCommentAsync(CallContext cntx, string _ID)
        {
            try
            {
                return await Channel.LoadEntityCommentAsync(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public void UpdateEntityComment(CallContext cntx, string _ID, string data)
        {
            try
            {
                Channel.UpdateEntityComment(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task UpdateEntityCommentAsync(CallContext cntx, string _ID, string data)
        {
            try
            {
                await Channel.UpdateEntityCommentAsync(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
