...
{
    /// <summary>
    /// Proxy for <see cref="IUserProfileService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.AddOrUpdateEntities" />, <see cref="UserProfileServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserProfileServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.NextPageBlock" /> and <see cref="UserProfileServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.QueryEntityCount" />, <see cref="UserProfileServiceProxy.QueryDatabase" />, <see cref="UserProfileServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.LoadEntityByKey" /> and <see cref="UserProfileServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.ConstraintQueryEntityCount" />, <see cref="UserProfileServiceProxy.ConstraintQuery" />, <see cref="UserProfileServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.GetNextSorterOps" /> and <see cref="UserProfileServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.LoadEntityBinaryValue" />, <see cref="UserProfileServiceProxy.LoadEntityStringValue" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="UserProfileServiceProxy.UpdateEntityBinaryValue" />, <see cref="UserProfileServiceProxy.UpdateEntityStringValue" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserProfileServiceProxy.MaterializeApplication_Ref" />, <see cref="UserProfileServiceProxy.MaterializeUserProfileTypeRef" />, <see cref="UserProfileServiceProxy.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserProfileServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserProfileServiceProxy : ClientBase<IUserProfileService2>, IUserProfileService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public UserProfileServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserProfileServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public UserProfileSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="UserProfileSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<UserProfileUpdateResult> AddOrUpdateEntities(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserProfileUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserProfileSet set, UserProfile[] entities)
        {
            try
            {
        ...
        /// </returns>
        public UserProfilePageBlock NextPageBlock(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, UserProfile prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="UserProfilePageBlock" /> data model for entity set "UserProfiles".
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfilePageBlock> NextPageBlockAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, UserProfile prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<UserProfile> GetPageItems(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, UserProfile prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="UserProfile" /> in set "UserProfiles" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> GetPageItemsAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, UserProfile prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserProfileSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<UserProfile> QueryDatabase(CallContext cntx, UserProfileSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> QueryDatabaseAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserProfile> QueryDatabaseLimited(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> QueryDatabaseLimitedAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UserProfileSet set, UserProfileSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserProfileSet set, UserProfileSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserProfile> ConstraintQuery(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> ConstraintQueryAsync(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserProfile> ConstraintQueryLimited(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserProfile>> ConstraintQueryLimitedAsync(CallContext cntx, UserProfileSet set, UserProfileSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, UserProfile entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, UserProfile entity)
        {
            try
            {
        ...
        /// </returns>
        public UserProfileType MaterializeUserProfileTypeRef(CallContext cntx, UserProfile entity)
        {
            try
            {
                var e = Channel.MaterializeUserProfileTypeRef(cntx, entity.ShallowCopy()); 
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        ///   An entity of type <see cref="UserProfileType" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfileType> MaterializeUserProfileTypeRefAsync(CallContext cntx, UserProfile entity)
        {
            try
            {
                var e = await Channel.MaterializeUserProfileTypeRefAsync(cntx, entity.ShallowCopy());
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        /// </returns>
        public User MaterializeUserRef(CallContext cntx, UserProfile entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, UserProfile entity)
        {
            try
            {
        ...
        public UserProfileSetConstraintsColl QuerySetConstraints(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserProfileSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<UserProfileSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserProfileSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        public UserProfile LoadEntityByKey(CallContext cntx, Int64 _ID)
        {
            try
            {
        ...
        ///   Null or the entity found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfile> LoadEntityByKeyAsync(CallContext cntx, Int64 _ID)
        {
            try
            {
        ...
        /// </returns>
        public UserProfile LoadEntityGraphRecurs(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        ///   Null or the entity graph found.
        /// </returns>
        public async System.Threading.Tasks.Task<UserProfile> LoadEntityGraphRecursAsync(CallContext cntx, Int64 _ID, EntitySetType[] excludedSets, EntitySetRelation[] futherDrillSets)
        {
            try
            {
        ...
        /// </returns>
        public List<UserProfile> LoadEntityByNature(CallContext cntx, string _PropName, string _ApplicationID, string _UserID)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _PropName, _ApplicationID, _UserID);
        ...
        ///   The list of found entities.
        /// </returns>
        public async System.Threading.Tasks.Task<List<UserProfile>> LoadEntityByNatureAsync(CallContext cntx, string _PropName, string _ApplicationID, string _UserID)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _PropName, _ApplicationID, _UserID);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
        ...
        /// </returns>
        public byte[] LoadEntityBinaryValue(CallContext cntx, Int64 _ID)
        {
            try
            {
                return Channel.LoadEntityBinaryValue(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<byte[]> LoadEntityBinaryValueAsync(CallContext cntx, Int64 _ID)
        {
            try
            {
                return await Channel.LoadEntityBinaryValueAsync(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public void UpdateEntityBinaryValue(CallContext cntx, Int64 _ID, byte[] data)
        {
            try
            {
                Channel.UpdateEntityBinaryValue(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task UpdateEntityBinaryValueAsync(CallContext cntx, Int64 _ID, byte[] data)
        {
            try
            {
                await Channel.UpdateEntityBinaryValueAsync(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public string LoadEntityStringValue(CallContext cntx, Int64 _ID)
        {
            try
            {
                return Channel.LoadEntityStringValue(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task<string> LoadEntityStringValueAsync(CallContext cntx, Int64 _ID)
        {
            try
            {
                return await Channel.LoadEntityStringValueAsync(cntx, _ID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public void UpdateEntityStringValue(CallContext cntx, Int64 _ID, string data)
        {
            try
            {
                Channel.UpdateEntityStringValue(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        ///   The value of the property.
        /// </returns>
        public async System.Threading.Tasks.Task UpdateEntityStringValueAsync(CallContext cntx, Int64 _ID, string data)
        {
            try
            {
                await Channel.UpdateEntityStringValueAsync(cntx, _ID, data);
            }
            catch (Exception ex)
            {
                HandleError(ex);
