...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UserProfileServiceProxy : ClientBase<IUserProfileService2>, IUserProfileService2
    {
        ...
        public UserProfileType MaterializeUserProfileTypeRef(CallContext cntx, UserProfile entity)
        {
            try
            {
                return Channel.MaterializeUserProfileTypeRef(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public async System.Threading.Tasks.Task<UserProfileType> MaterializeUserProfileTypeRefAsync(CallContext cntx, UserProfile entity)
        {
            try
            {
                return await Channel.MaterializeUserProfileTypeRefAsync(cntx, entity.ShallowCopy());
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public List<UserProfile> LoadEntityByNature(CallContext cntx, string _PropName, string _ApplicationID, string _UserID)
        {
            try
            {
                return Channel.LoadEntityByNature(cntx, _PropName, _ApplicationID, _UserID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
        ...
        public async System.Threading.Tasks.Task<List<UserProfile>> LoadEntityByNatureAsync(CallContext cntx, string _PropName, string _ApplicationID, string _UserID)
        {
            try
            {
                return await Channel.LoadEntityByNatureAsync(cntx, _PropName, _ApplicationID, _UserID);
            }
            catch (Exception ex)
            {
                HandleError(ex);
