...
{
    /// <summary>
    /// Proxy for <see cref="IUserDetailService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.AddOrUpdateEntities" />, <see cref="UserDetailServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="UserDetailServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.NextPageBlock" /> and <see cref="UserDetailServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.QueryEntityCount" />, <see cref="UserDetailServiceProxy.QueryDatabase" />, <see cref="UserDetailServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.LoadEntityByKey" /> and <see cref="UserDetailServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.ConstraintQueryEntityCount" />, <see cref="UserDetailServiceProxy.ConstraintQuery" />, <see cref="UserDetailServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.GetNextSorterOps" /> and <see cref="UserDetailServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.LoadEntityDescription" />, <see cref="UserDetailServiceProxy.LoadEntityPhoto" />
    ///      </description>
    ///    </item>
    ///    <item>
    ///      <term>Methods (uploading)</term>
    ///      <description>
    ///         <see cref="UserDetailServiceProxy.UpdateEntityDescription" />, <see cref="UserDetailServiceProxy.UpdateEntityPhoto" />
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserDetailServiceProxy.MaterializeApplication_Ref" />, <see cref="UserDetailServiceProxy.MaterializeUserRef" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="UserDetailServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class UserDetailServiceProxy : ClientBase<IUserDetailService2>, IUserDetailService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public UserDetailServiceProxy() 
            : base("HTTP")
        {
        ...
        public UserDetailServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public UserDetailServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public UserDetailSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="UserDetailSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<UserDetailSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<UserDetailUpdateResult> AddOrUpdateEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<UserDetailUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, UserDetailSet set, UserDetail[] entities)
        {
            try
            {
        ...
        /// </returns>
        public UserDetailPageBlock NextPageBlock(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="UserDetailPageBlock" /> data model for entity set "UserDetails".
        /// </returns>
        public async System.Threading.Tasks.Task<UserDetailPageBlock> NextPageBlockAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<UserDetail> GetPageItems(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="UserDetail" /> in set "UserDetails" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserDetail>> GetPageItemsAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, UserDetail prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, UserDetailSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<UserDetail> QueryDatabase(CallContext cntx, UserDetailSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserDetail>> QueryDatabaseAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserDetail> QueryDatabaseLimited(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserDetail>> QueryDatabaseLimitedAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, UserDetailSet set, UserDetailSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserDetail> ConstraintQuery(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserDetail>> ConstraintQueryAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<UserDetail> ConstraintQueryLimited(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<UserDetail>> ConstraintQueryLimitedAsync(CallContext cntx, UserDetailSet set, UserDetailSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, UserDetail entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, UserDetail entity)
        {
            try
            {
        ...
        /// </returns>
        public User MaterializeUserRef(CallContext cntx, UserDetail entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="User" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<User> MaterializeUserRefAsync(CallContext cntx, UserDetail entity)
        {
            try
            {
        ...
        public UserDetailSetConstraintsColl QuerySetConstraints(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
        ...
        /// </returns>
        /// <remarks>It will throw an exception if the <see cref="UserDetailSet.SetFilter" /> of <paramref name="set" /> is null or empty.</remarks>
        public async System.Threading.Tasks.Task<UserDetailSetConstraintsColl> QuerySetConstraintsAsync(CallContext cntx, UserDetailSet set, QueryExpresion qexpr, int max, string nextId)
        {
            try
            {
