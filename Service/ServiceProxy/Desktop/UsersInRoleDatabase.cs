...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UsersInRoleServiceProxy : ClientBase<IUsersInRoleService2>, IUsersInRoleService2
    {
        ...
        public User MaterializeUser_AdminID(CallContext cntx, UsersInRole entity)
        {
            try
            {
                var e = Channel.MaterializeUser_AdminID(cntx, entity.ShallowCopy()); 
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public async System.Threading.Tasks.Task<User> MaterializeUser_AdminIDAsync(CallContext cntx, UsersInRole entity)
        {
            try
            {
                var e = await Channel.MaterializeUser_AdminIDAsync(cntx, entity.ShallowCopy());
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public UsersInRole LoadEntityByKey(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
                var e = Channel.LoadEntityByKey(cntx, _RoleID, _UserID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public async System.Threading.Tasks.Task<UsersInRole> LoadEntityByKeyAsync(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
                var e = await Channel.LoadEntityByKeyAsync(cntx, _RoleID, _UserID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public List<UsersInRole> LoadEntityByNature(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _RoleID, _UserID);
        ...
        public async System.Threading.Tasks.Task<List<UsersInRole>> LoadEntityByNatureAsync(CallContext cntx, int _RoleID, string _UserID)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _RoleID, _UserID);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
