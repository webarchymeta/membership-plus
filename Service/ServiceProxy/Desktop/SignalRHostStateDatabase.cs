...
{
    /// <summary>
    /// Proxy for <see cref="ISignalRHostStateService2" /> service.
    /// </summary>
    /// <remarks>
    ///  <para>
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.AddOrUpdateEntities" />, <see cref="SignalRHostStateServiceProxy.EnqueueNewOrUpdateEntities" />, and <see cref="SignalRHostStateServiceProxy.DeleteEntities" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.NextPageBlock" /> and <see cref="SignalRHostStateServiceProxy.GetPageItems" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.QueryEntityCount" />, <see cref="SignalRHostStateServiceProxy.QueryDatabase" />, <see cref="SignalRHostStateServiceProxy.QueryDatabaseLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.LoadEntityByKey" /> and <see cref="SignalRHostStateServiceProxy.LoadEntityByNature" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.ConstraintQueryEntityCount" />, <see cref="SignalRHostStateServiceProxy.ConstraintQuery" />, <see cref="SignalRHostStateServiceProxy.ConstraintQueryLimited" />,
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///         <see cref="SignalRHostStateServiceProxy.GetNextSorterOps" /> and <see cref="SignalRHostStateServiceProxy.GetNextFilterOps" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="SignalRHostStateServiceProxy.MaterializeApplication_Ref" />.
    ///      </description>
    ///    </item>
    ///  </list>
    ///  <list type="table">
    ...
    ///      <term>Methods</term>
    ///      <description>
    ///        <see cref="SignalRHostStateServiceProxy.LoadEntityGraphRecurs" />.
    ///      </description>
    ///    </item>
    ///  </list>
    /// </remarks>
    public class SignalRHostStateServiceProxy : ClientBase<ISignalRHostStateService2>, ISignalRHostStateService2
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public SignalRHostStateServiceProxy() 
            : base("HTTP")
        {
        ...
        public SignalRHostStateServiceProxy(string svcConfig) 
            : base(svcConfig)
        {
        ...
        public SignalRHostStateServiceProxy(Binding binding, EndpointAddress remoteAddress)
        ...
        /// </returns>
        public SignalRHostStateSet GetSetInfo(CallContext cntx, string filter)
        {
            try
            {
        ...
        ///   Entity set: <see cref="SignalRHostStateSet" /> data model.
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRHostStateSet> GetSetInfoAsync(CallContext cntx, string filter)
        {
            try
            {
        ...
        /// </returns>
        public ChangeOpResults<SignalRHostStateUpdateResult> AddOrUpdateEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="ChangeOpResults{T}" /> which contains operation messages, if any, and a list of successfully added or updated entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ChangeOpResults<SignalRHostStateUpdateResult>> AddOrUpdateEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public void EnqueueNewOrUpdateEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        /// <returns>
        /// </returns>
        public async System.Threading.Tasks.Task EnqueueNewOrUpdateEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        /// </returns>
        public OperationResults DeleteEntities(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        ///   Operation result contained inside an object of type <see cref="OperationResults" /> which contains operation messages, if any.
        /// </returns>
        public async System.Threading.Tasks.Task<OperationResults> DeleteEntitiesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostState[] entities)
        {
            try
            {
        ...
        /// </returns>
        public SignalRHostStatePageBlock NextPageBlock(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   <see cref="SignalRHostStatePageBlock" /> data model for entity set "SignalRHostStates".
        /// </returns>
        public async System.Threading.Tasks.Task<SignalRHostStatePageBlock> NextPageBlockAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public IEnumerable<SignalRHostState> GetPageItems(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        ///   Collection of <see cref="SignalRHostState" /> in set "SignalRHostStates" for the current page defined by "prevlast".
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> GetPageItemsAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, SignalRHostState prevlast)
        {
            try
            {
                if (prevlast != null)
        ...
        /// </returns>
        public Int64 QueryEntityCount(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> QueryEntityCountAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public IEnumerable<SignalRHostState> QueryDatabase(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> QueryDatabaseAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRHostState> QueryDatabaseLimited(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> QueryDatabaseLimitedAsync(CallContext cntx, SignalRHostStateSet set, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public Int64 ConstraintQueryEntityCount(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The number of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<Int64> ConstraintQueryEntityCountAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        /// </returns>
        public ConstraintsPtr[] ConstraintsFindMatches(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   A set of constraint pointer that has non-zero corresponding entities.
        /// </returns>
        public async System.Threading.Tasks.Task<ConstraintsPtr[]> ConstraintsFindMatchesAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints[] cnstSets, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRHostState> ConstraintQuery(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> ConstraintQueryAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public IEnumerable<SignalRHostState> ConstraintQueryLimited(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        ///   The collection of entities.
        /// </returns>
        public async System.Threading.Tasks.Task<IEnumerable<SignalRHostState>> ConstraintQueryLimitedAsync(CallContext cntx, SignalRHostStateSet set, SignalRHostStateSetConstraints constraints, QueryExpresion qexpr, int maxRecords)
        {
            try
            {
        ...
        /// </returns>
        public Application_ MaterializeApplication_Ref(CallContext cntx, SignalRHostState entity)
        {
            try
            {
        ...
        ///   An entity of type <see cref="Application_" /> or null.
        /// </returns>
        public async System.Threading.Tasks.Task<Application_> MaterializeApplication_RefAsync(CallContext cntx, SignalRHostState entity)
        {
            try
            {
