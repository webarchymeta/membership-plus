...
namespace CryptoGateway.RDB.Data.MembershipPlus
{
    ...
    public class UserGroupAdminRoleServiceProxy : ClientBase<IUserGroupAdminRoleService2>, IUserGroupAdminRoleService2
    {
        ...
        public Role MaterializeRoleRef(CallContext cntx, UserGroupAdminRole entity)
        {
            try
            {
                var e = Channel.MaterializeRoleRef(cntx, entity.ShallowCopy()); 
                if (e != null)
        ...
        public async System.Threading.Tasks.Task<Role> MaterializeRoleRefAsync(CallContext cntx, UserGroupAdminRole entity)
        {
            try
            {
                var e = await Channel.MaterializeRoleRefAsync(cntx, entity.ShallowCopy());
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public UserGroupAdminRole LoadEntityByKey(CallContext cntx, string _GroupID, int _RoleID)
        {
            try
            {
                var e = Channel.LoadEntityByKey(cntx, _GroupID, _RoleID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public async System.Threading.Tasks.Task<UserGroupAdminRole> LoadEntityByKeyAsync(CallContext cntx, string _GroupID, int _RoleID)
        {
            try
            {
                var e = await Channel.LoadEntityByKeyAsync(cntx, _GroupID, _RoleID);
                if (e != null)
                    e.StartAutoUpdating = true;
                return e;
            }
        ...
        public List<UserGroupAdminRole> LoadEntityByNature(CallContext cntx, string _GroupID, int _RoleID)
        {
            try
            {
                var list = Channel.LoadEntityByNature(cntx, _GroupID, _RoleID);
        ...
        public async System.Threading.Tasks.Task<List<UserGroupAdminRole>> LoadEntityByNatureAsync(CallContext cntx, string _GroupID, int _RoleID)
        {
            try
            {
                var list = await Channel.LoadEntityByNatureAsync(cntx, _GroupID, _RoleID);
                return list == null ? null : list.Select(d => { d.StartAutoUpdating = true; return d; }).ToList();
            }
            catch (Exception ex)
            {
